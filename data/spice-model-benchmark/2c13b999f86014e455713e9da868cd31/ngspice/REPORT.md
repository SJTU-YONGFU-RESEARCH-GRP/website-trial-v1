...
Generated on: 2026-07-28 20:17:24
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/2c13b999f86014e455713e9da868cd31/ngspice/netlist/dc.cir
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/2c13b999f86014e455713e9da868cd31/ngspice/netlist/transient.cir
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/2c13b999f86014e455713e9da868cd31/ngspice/netlist/ac.cir
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/2c13b999f86014e455713e9da868cd31/ngspice/netlist/noise.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -1.01e-05A to 4.44e-23A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -5.52e-06A to 4.05e-36A, IG: 0.00e+00A to 0.00e+00A, IS: -1.73e-35A to 5.52e-06A, IB: -3.05e-43A to 1.12e-14A, KCL Error: 0.00%, Power: 0.00e+00W to 6.62e-06W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: -0.000000 /°C, IDS: -1.008e-05A to 4.442e-23A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 1.210e-05W, Efficiency: 1.005e+01 to 5.008e+09, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 1.08fF to 1.34fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: 0dB to 0dB, S21 range: -72dB to -68dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.289 |
...
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 422.2ps, Power: 3.738e-05W (max), 1.344e-07W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 1202.2ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -5.708397e-08W/°C |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -5.52e-06A to 4.05e-36A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: -1.73e-35A to 5.52e-06A
  - IB: -3.05e-43A to 1.12e-14A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -1.008e-05A to 4.442e-23A
...
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 1.005e+01 to 5.008e+09
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 1.086088e-06A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 422.2ps

  - Maximum Switching Power: 3.737660e-05W

  - Average Switching Power: 1.343694e-07W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 602.2ps

  - Stage 2 Delay: 290.0ps

  - Stage 3 Delay: 310.0ps

  - Total Delay: 1202.2ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 3.737660e-05W

  - Maximum Power at 100°C: 3.320947e-05W

  - Average Power at 27°C: 1.343694e-07W

  - Average Power at 100°C: 1.271910e-07W

  - Power Temperature Coefficient: -5.708397e-08W/°C
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 2.353237 fF/µm²
    - Cgs_ls/Area: -0.926612 fF/µm²
    - Cgd_ls/Area: -0.816222 fF/µm²
    - Cgb_ls/Area: -0.610405 fF/µm²
...
- [<span style='color: green'>✓</span>] S-parameter analysis verified
  ...
  - S21 range: -72dB to -68dB
  - S12 range: -134dB to -74dB
...
- [<span style='color: green'>✓</span>] Flicker noise analysis completed
  ...
  - Exponent (γ): -2.03e-16 (ideally -1.0 for pure 1/f noise)
  - Correlation (R²): 0.2708
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Standard Deviation: 5.57e-17 V²/Hz
...
- Model: `sky130__fd__bs__flash__special__sonosfet__original__model__original`
- Model MD5: `2c13b999f86014e455713e9da868cd31`
- Simulator: `ngspice`
- Modes: `dc, transient, ac, noise`
- Started: `2026-07-28T12:16:17.128294+00:00`
- Finished: `2026-07-28T12:17:46.202897+00:00`
- Elapsed seconds: `89.07462`
- Peak resident memory KiB: `234020`
