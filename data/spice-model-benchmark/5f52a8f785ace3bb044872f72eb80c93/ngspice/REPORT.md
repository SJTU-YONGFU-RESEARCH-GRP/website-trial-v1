...
Generated on: 2026-07-28 21:35:07
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/5f52a8f785ace3bb044872f72eb80c93/ngspice/netlist/dc.cir
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/5f52a8f785ace3bb044872f72eb80c93/ngspice/netlist/transient.cir
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/5f52a8f785ace3bb044872f72eb80c93/ngspice/netlist/ac.cir
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/5f52a8f785ace3bb044872f72eb80c93/ngspice/netlist/noise.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -2.83e-04A to 0.00e+00A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -2.27e-04A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 2.27e-04A, IB: 0.00e+00A to 1.20e-15A, KCL Error: 0.00%, Power: 0.00e+00W to 2.72e-04W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: -0.000000 /°C, IDS: -2.832e-04A to 0.000e+00A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 3.398e-04W, Efficiency: 1.241e+00 to 4.147e+03, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 53.19fF to 95.55fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -54dB to -39dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 176.88 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 4.542e-05A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 310.8ps, Power: 7.746e-05W (max), 1.903e-06W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 2537.4ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: 1.897143e-08W/°C |
...
| [Flicker (1/f) Noise](#flicker-noise-analysis) | <span style='color: green'>✓</span> | Exponent: 0.0007, Corner Freq: not resolved |
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 3.63e-07 V²/Hz, Variation: 2.0077 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -2.27e-04A to 0.00e+00A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: 0.00e+00A to 2.27e-04A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -2.832e-04A to 0.000e+00A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 3.398e-04W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 1.241e+00 to 4.147e+03
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 4.541937e-05A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 310.8ps

  - Maximum Switching Power: 7.746111e-05W

  - Average Switching Power: 1.902700e-06W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 537.7ps

  - Stage 2 Delay: 1069.6ps

  - Stage 3 Delay: 930.0ps

  - Total Delay: 2537.4ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 7.746111e-05W

  - Maximum Power at 100°C: 7.884603e-05W

  - Average Power at 27°C: 1.902700e-06W

  - Average Power at 100°C: 1.712445e-06W

  - Power Temperature Coefficient: 1.897143e-08W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 53.19fF to 95.55fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 0.927164 fF/µm²
    - Cgs_ls/Area: -0.226905 fF/µm²
    - Cgd_ls/Area: -0.196720 fF/µm²
    - Cgb_ls/Area: -0.503539 fF/µm²
...
- [<span style='color: green'>✓</span>] S-parameter analysis verified
  ...
  - S21 range: -54dB to -39dB
  - S12 range: -103dB to -43dB
...
- [<span style='color: green'>✓</span>] Flicker noise analysis completed
  ...
  - Exponent (γ): 6.62e-04 (ideally -1.0 for pure 1/f noise)
  - Correlation (R²): 0.4698
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 3.63e-07 V²/Hz
  - Standard Deviation: 7.28e-07 V²/Hz
  - Variation Coefficient: 2.0077
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.998929681939817
...
- Model: `sky130__fd__pr__nfet__20v0__base__reduction`
- Model MD5: `5f52a8f785ace3bb044872f72eb80c93`
- Simulator: `ngspice`
- Modes: `dc, transient, ac, noise`
- Started: `2026-07-28T12:47:27.403536+00:00`
- Finished: `2026-07-28T13:35:46.083078+00:00`
- Elapsed seconds: `2898.679555`
- Peak resident memory KiB: `215080`
