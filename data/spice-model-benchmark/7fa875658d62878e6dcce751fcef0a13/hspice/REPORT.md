...
Generated on: 2026-07-30 01:01:51
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/7fa875658d62878e6dcce751fcef0a13/hspice/netlist/dc.sp
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/7fa875658d62878e6dcce751fcef0a13/hspice/netlist/transient.sp
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/7fa875658d62878e6dcce751fcef0a13/hspice/netlist/ac.sp
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/7fa875658d62878e6dcce751fcef0a13/hspice/netlist/noise.sp
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -1.13e-02A to 0.00e+00A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -6.97e-03A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 6.85e-05A, IB: 0.00e+00A to 6.90e-03A, KCL Error: 0.00%, Power: 0.00e+00W to 8.36e-03W, Temp: -40.0°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: -0.000009 /°C, IDS: -1.132e-02A to 0.000e+00A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 1.358e-02W, Efficiency: 1.055e+02 to 6.340e+12, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 63.57fF to 80.45fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0.0111677dB to 0dB, S21 range: -107.615dB to -47.6304dB |
...
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 493.717ps (sample interval 10ps), Power: 2.373e-04W (max), 1.019e-06W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 5901.45ps (sample interval 10ps) |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: 4.994784e-07W/°C |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Thermal Noise](#thermal-noise-analysis) | <span style='color: green'>✓</span> | Floor: 2.50e-10 V²/Hz, Range: 5.60e-16 V²/Hz to 2.37e-09 V²/Hz |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -6.97e-03A to 0.00e+00A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: 0.00e+00A to 6.85e-05A
  - IB: 0.00e+00A to 6.90e-03A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -1.132e-02A to 0.000e+00A
...
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 1.055e+02 to 6.340e+12
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: -6.894168e-03A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 493.717ps
  - Transient sample interval: 10ps

  - Maximum Switching Power: 2.372696e-04W

  - Average Switching Power: 1.019056e-06W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 1016.14ps

  - Stage 2 Delay: 1856.15ps

  - Stage 3 Delay: 1322.78ps

  - Total Delay: 5901.45ps
  - Transient sample interval: 10ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 2.372696e-04W

  - Maximum Power at 100°C: 2.737315e-04W

  - Average Power at 27°C: 1.019056e-06W

  - Average Power at 100°C: 9.946568e-07W

  - Power Temperature Coefficient: 4.994784e-07W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 63.57fF to 80.45fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 6.861872 fF/µm²
    - Cgs_ls/Area: -1.265690 fF/µm²
    - Cgd_ls/Area: -2.816173 fF/µm²
    - Cgb_ls/Area: -2.780009 fF/µm²
...
- [<span style='color: green'>✓</span>] S-parameter analysis verified
  - S11 range: -0.0111677dB to 0dB
  - S21 range: -107.615dB to -47.6304dB
  - S12 range: -95.0138dB to -35.025dB
  - S22 range: -8.08595dB to -8.08425dB
...
- [<span style='color: green'>✓</span>] Thermal noise analysis completed
  - Max Noise: 2.37e-09 V²/Hz
  - Min Noise: 5.60e-16 V²/Hz
  - Avg Noise: 2.29e-10 V²/Hz
  - Noise Floor: 2.50e-10 V²/Hz
...
- [<span style='color: green'>✓</span>] Flicker noise analysis completed
  ...
  - Exponent (γ): 4.28e-09 (ideally -1.0 for pure 1/f noise)
  - Correlation (R²): 0.4667
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Standard Deviation: 1.91e-15 V²/Hz
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.8682237189298776
...
| Vgs=0.3V, Vds=0.6V | 2.24e-11 | 3.02e-12 | 3.81e-12 | 4.57e-12 |
| Vgs=0.3V, Vds=0.9V | 2.37e-09 | 4.80e-10 | 6.16e-10 | 4.80e-10 |
| Vgs=0.3V, Vds=1.2V | 2.36e-09 | 6.30e-10 | 7.48e-10 | 6.30e-10 |
| Vgs=0.6V, Vds=0.3V | 1.79e-11 | 5.60e-16 | 9.11e-13 | 1.81e-12 |
| Vgs=0.6V, Vds=0.6V | 2.09e-11 | 2.75e-12 | 3.48e-12 | 4.21e-12 |

<!-- collection-run-integrity -->
## Run Integrity

- Model: `sky130__fd__pr__pfet__01v8__model__expansion_translation`
- Model MD5: `7fa875658d62878e6dcce751fcef0a13`
- Simulator: `hspice`
- Modes: `dc, transient, ac, noise`
- Started: `2026-07-29T16:59:05.365880+00:00`
- Finished: `2026-07-29T17:02:15.241504+00:00`
- Elapsed seconds: `189.875634`
- Peak resident memory KiB: `295116`
