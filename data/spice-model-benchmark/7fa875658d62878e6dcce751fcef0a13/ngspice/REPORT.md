...
Generated on: 2026-07-28 22:15:34
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/7fa875658d62878e6dcce751fcef0a13/ngspice/netlist/dc.cir
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/7fa875658d62878e6dcce751fcef0a13/ngspice/netlist/transient.cir
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/7fa875658d62878e6dcce751fcef0a13/ngspice/netlist/ac.cir
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/7fa875658d62878e6dcce751fcef0a13/ngspice/netlist/noise.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: -1.20V to 0.00V, VGS: -1.20V to 0.00V, IDS: -3.51e-36A to 3.76e-05A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -2.27e-42A to 1.38e-05A, IG: 0.00e+00A to 0.00e+00A, IS: -1.38e-05A to -1.06e-54A, IB: -6.84e-15A to 3.15e-42A, KCL Error: 0.00%, Power: 0.00e+00W to 1.65e-05W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000000 /°C, IDS: -3.515e-36A to 3.763e-05A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 4.515e-05W, Efficiency: 8.782e-04 to 1.654e+10, TC: 5.39e-02/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 21.33fF to 78.49fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -86dB to -49dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 146.131 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 5.925e-05A, Rise Time: 0.0ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 493.9ps, Power: 2.364e-04W (max), 8.908e-07W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 5778.1ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: 4.786922e-07W/°C |
...
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 2.44e-08 V²/Hz, Variation: 1.1150 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -2.27e-42A to 1.38e-05A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: -1.38e-05A to -1.06e-54A
  - IB: -6.84e-15A to 3.15e-42A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -3.515e-36A to 3.763e-05A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 4.515e-05W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 8.782e-04 to 1.654e+10
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: 5.39e-02/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 5.924617e-05A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 493.9ps

  - Maximum Switching Power: 2.364355e-04W

  - Average Switching Power: 8.907945e-07W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 988.1ps

  - Stage 2 Delay: 3490.0ps

  - Stage 3 Delay: 1300.0ps

  - Total Delay: 5778.1ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 2.364355e-04W

  - Maximum Power at 100°C: 2.713800e-04W

  - Average Power at 27°C: 8.907945e-07W

  - Average Power at 100°C: 8.065566e-07W

  - Power Temperature Coefficient: 4.786922e-07W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 21.33fF to 78.49fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 4.289461 fF/µm²
    - Cgs_ls/Area: -0.467402 fF/µm²
    - Cgd_ls/Area: -0.330999 fF/µm²
    - Cgb_ls/Area: -3.491060 fF/µm²
...
- [<span style='color: green'>✓</span>] S-parameter analysis verified
  ...
  - S21 range: -86dB to -49dB
  - S12 range: -128dB to -68dB
...
- [<span style='color: green'>✓</span>] Flicker noise analysis completed
  ...
  - Exponent (γ): 4.15e-05 (ideally -1.0 for pure 1/f noise)
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 2.44e-08 V²/Hz
  - Standard Deviation: 2.72e-08 V²/Hz
  - Variation Coefficient: 1.1150
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.9989296819398241
...
- Started: `2026-07-28T13:32:19.341521+00:00`
- Finished: `2026-07-28T14:16:10.543714+00:00`
- Elapsed seconds: `2631.202199`
- Peak resident memory KiB: `234844`
