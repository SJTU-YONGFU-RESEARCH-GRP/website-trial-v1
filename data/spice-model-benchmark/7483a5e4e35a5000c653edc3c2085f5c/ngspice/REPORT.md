...
Generated on: 2026-07-28 20:19:15
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/7483a5e4e35a5000c653edc3c2085f5c/ngspice/netlist/dc.cir
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/7483a5e4e35a5000c653edc3c2085f5c/ngspice/netlist/transient.cir
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/7483a5e4e35a5000c653edc3c2085f5c/ngspice/netlist/ac.cir
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/7483a5e4e35a5000c653edc3c2085f5c/ngspice/netlist/noise.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -5.85e-06A to 0.00e+00A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -2.56e-06A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 2.56e-06A, IB: 0.00e+00A to 1.20e-15A, KCL Error: 0.00%, Power: 0.00e+00W to 3.08e-06W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: -0.000000 /°C, IDS: -5.850e-06A to 0.000e+00A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 7.020e-06W, Efficiency: 3.064e-01 to 4.160e+03, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 30.94fF to 111.84fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -107dB to -47dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 90.3252 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 5.280e-05A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 2892.2ps, Power: 7.788e-05W (max), 8.809e-07W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 60.0ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: 1.999688e-08W/°C |
...
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 1.29e-08 V²/Hz, Variation: 0.0005 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -2.56e-06A to 0.00e+00A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: 0.00e+00A to 2.56e-06A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -5.850e-06A to 0.000e+00A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 7.020e-06W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 3.064e-01 to 4.160e+03
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 5.280247e-05A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 2892.2ps

  - Maximum Switching Power: 7.787532e-05W

  - Average Switching Power: 8.809333e-07W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 7862.2ps

  - Stage 2 Delay: 3263.6ps

  - Stage 3 Delay: 5824.8ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 7.787532e-05W

  - Maximum Power at 100°C: 7.933509e-05W

  - Average Power at 27°C: 8.809333e-07W

  - Average Power at 100°C: 8.994436e-07W

  - Power Temperature Coefficient: 1.999688e-08W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 30.94fF to 111.84fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 1.617895 fF/µm²
    - Cgs_ls/Area: -0.181737 fF/µm²
    - Cgd_ls/Area: -0.149425 fF/µm²
    - Cgb_ls/Area: -1.286733 fF/µm²
...
- [<span style='color: green'>✓</span>] Flicker noise analysis completed
  ...
  - Exponent (γ): 3.59e-11 (ideally -1.0 for pure 1/f noise)
  - Correlation (R²): 0.4680
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Standard Deviation: 6.19e-12 V²/Hz
  - Variation Coefficient: 0.0005
...
- Model: `sky130__fd__pr__cap__vpp__11p3x11p8__l1m1m2m3m4__shieldm5__nhv__base__model__fitting_reduction_translation`
- Model MD5: `7483a5e4e35a5000c653edc3c2085f5c`
- Simulator: `ngspice`
- Modes: `dc, transient, ac, noise`
- Started: `2026-07-28T12:17:54.644326+00:00`
- Finished: `2026-07-28T12:19:40.768871+00:00`
- Elapsed seconds: `106.124568`
- Peak resident memory KiB: `231244`
