...
Generated on: 2026-07-27 10:23:36
...
- [<span style='color: green'>✓</span>] Circuit file exists and is readable
  - Path: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/bc9c8d1a1a08be9f735d1b512bea6092/ngspice/_ngspice_netlists/dc_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/bc9c8d1a1a08be9f735d1b512bea6092/ngspice/_ngspice_netlists/transient_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/bc9c8d1a1a08be9f735d1b512bea6092/ngspice/_ngspice_netlists/noise_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/bc9c8d1a1a08be9f735d1b512bea6092/ngspice/_ngspice_netlists/ac_circuit.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: -1.20V to 0.00V, VGS: -1.20V to 0.00V, IDS: 0.00e+00A to 6.38e-04A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: 0.00e+00A to 5.02e-04A, IG: 0.00e+00A to 0.00e+00A, IS: -5.02e-04A to 0.00e+00A, IB: -1.20e-15A to 0.00e+00A, KCL Error: 0.00%, Power: 0.00e+00W to 6.03e-04W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: -0.000000 /°C, IDS: 0.000e+00A to 6.377e-04A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 7.653e-04W, Efficiency: 1.907e+00 to 2.748e+10, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 47.25fF to 243.47fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -23dB to -21dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.601 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 6.953e-04A, Rise Time: 0.0ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 149.3ps, Power: 2.574e-05W (max), 1.006e-06W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 203.4ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -4.178056e-08W/°C |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: 0.00e+00A to 5.02e-04A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: -5.02e-04A to 0.00e+00A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: 0.000e+00A to 6.377e-04A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 7.653e-04W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 1.907e+00 to 2.748e+10
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 6.952942e-04A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 149.3ps

  - Maximum Switching Power: 2.573995e-05W

  - Average Switching Power: 1.005656e-06W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 149.3ps

  - Stage 2 Delay: 33.7ps

  - Stage 3 Delay: 20.4ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 2.573995e-05W

  - Maximum Power at 100°C: 2.268996e-05W

  - Average Power at 27°C: 1.005656e-06W

  - Average Power at 100°C: 1.018317e-06W

  - Power Temperature Coefficient: -4.178056e-08W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 47.25fF to 243.47fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 13.568865 fF/µm²
    - Cgs_ls/Area: -3.278106 fF/µm²
    - Cgd_ls/Area: -2.270874 fF/µm²
    - Cgb_ls/Area: -8.019858 fF/µm²
...
- [<span style='color: green'>✓</span>] S-parameter analysis verified
  ...
  - S21 range: -23dB to -21dB
  - S12 range: -116dB to -57dB
...
- Started: `2026-07-27T02:22:41.783639+00:00`
- Finished: `2026-07-27T02:23:37.363855+00:00`
- Elapsed seconds: `55.580196`
- Peak resident memory KiB: `201812`
