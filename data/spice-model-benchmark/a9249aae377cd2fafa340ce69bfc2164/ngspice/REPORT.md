...
Generated on: 2026-07-27 06:13:13
...
- [<span style='color: green'>✓</span>] Circuit file exists and is readable
  - Path: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/a9249aae377cd2fafa340ce69bfc2164/ngspice/_ngspice_netlists/dc_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/a9249aae377cd2fafa340ce69bfc2164/ngspice/_ngspice_netlists/transient_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/a9249aae377cd2fafa340ce69bfc2164/ngspice/_ngspice_netlists/noise_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/a9249aae377cd2fafa340ce69bfc2164/ngspice/_ngspice_netlists/ac_circuit.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -5.59e-04A to 0.00e+00A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -4.20e-04A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 4.20e-04A, IB: 0.00e+00A to 1.20e-15A, KCL Error: 0.00%, Power: 0.00e+00W to 5.04e-04W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000000 /°C, IDS: -5.595e-04A to 0.000e+00A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 6.714e-04W, Efficiency: 2.772e+00 to 3.996e+02, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 25.49fF to 97.10fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -26dB to -26dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.808 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 4.693e-05A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 360.2ps, Power: 1.179e-03W (max), 6.346e-05W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 2050.5ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -2.616977e-07W/°C |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -4.20e-04A to 0.00e+00A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: 0.00e+00A to 4.20e-04A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -5.595e-04A to 0.000e+00A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 6.714e-04W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 2.772e+00 to 3.996e+02
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 4.693330e-05A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 360.2ps

  - Maximum Switching Power: 1.178842e-03W

  - Average Switching Power: 6.346408e-05W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 646.1ps

  - Stage 2 Delay: 1018.3ps

  - Stage 3 Delay: 386.1ps

  - Total Delay: 2050.5ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 1.178842e-03W

  - Maximum Power at 100°C: 1.159738e-03W

  - Average Power at 27°C: 6.346408e-05W

  - Average Power at 100°C: 3.726724e-05W

  - Power Temperature Coefficient: -2.616977e-07W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 25.49fF to 97.10fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 5.778640 fF/µm²
    - Cgs_ls/Area: -1.138007 fF/µm²
    - Cgd_ls/Area: -0.796149 fF/µm²
    - Cgb_ls/Area: -3.844488 fF/µm²
...
- Started: `2026-07-26T22:11:23.297074+00:00`
- Finished: `2026-07-26T22:13:14.248710+00:00`
- Elapsed seconds: `110.951619`
- Peak resident memory KiB: `208008`
