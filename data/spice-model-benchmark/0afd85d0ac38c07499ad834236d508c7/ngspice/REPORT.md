...
Generated on: 2026-07-28 22:03:37
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/0afd85d0ac38c07499ad834236d508c7/ngspice/netlist/dc.cir
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/0afd85d0ac38c07499ad834236d508c7/ngspice/netlist/transient.cir
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/0afd85d0ac38c07499ad834236d508c7/ngspice/netlist/ac.cir
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/0afd85d0ac38c07499ad834236d508c7/ngspice/netlist/noise.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: -1.20V to 0.00V, VGS: -1.20V to 0.00V, IDS: -1.75e-33A to 2.30e-05A |
...
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000000 /°C, IDS: -1.749e-33A to 2.296e-05A |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 19.99fF to 77.38fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -100dB to -51dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 107.188 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 5.233e-05A, Rise Time: 0.0ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 500.4ps, Power: 2.189e-04W (max), 1.026e-06W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 9425.4ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: 3.241824e-07W/°C |
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -1.749e-33A to 2.296e-05A
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 5.233499e-05A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 500.4ps

  - Maximum Switching Power: 2.189036e-04W

  - Average Switching Power: 1.026283e-06W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 985.4ps

  - Stage 2 Delay: 5970.0ps

  - Stage 3 Delay: 2470.0ps

  - Total Delay: 9425.4ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 2.189036e-04W

  - Maximum Power at 100°C: 2.425689e-04W

  - Average Power at 27°C: 1.026283e-06W

  - Average Power at 100°C: 6.549897e-07W

  - Power Temperature Coefficient: 3.241824e-07W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 19.99fF to 77.38fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 4.441397 fF/µm²
    - Cgs_ls/Area: -0.427442 fF/µm²
    - Cgd_ls/Area: -0.308482 fF/µm²
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.9989296819398269
...
- Model: `sky130__fd__pr__pfet__01v8__hvt__model__original`
- Model MD5: `0afd85d0ac38c07499ad834236d508c7`
- Simulator: `ngspice`
- Modes: `dc, transient, ac, noise`
- Started: `2026-07-28T13:20:39.301354+00:00`
- Finished: `2026-07-28T14:04:11.276382+00:00`
- Elapsed seconds: `2611.97504`
- Peak resident memory KiB: `232828`
