...
Generated on: 2026-07-27 06:01:54
...
- [<span style='color: green'>✓</span>] Circuit file exists and is readable
  - Path: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/9f0345a55dfc700f456a8bd23c9925d0/ngspice/_ngspice_netlists/dc_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/9f0345a55dfc700f456a8bd23c9925d0/ngspice/_ngspice_netlists/transient_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/9f0345a55dfc700f456a8bd23c9925d0/ngspice/_ngspice_netlists/noise_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/9f0345a55dfc700f456a8bd23c9925d0/ngspice/_ngspice_netlists/ac_circuit.cir
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 51.19fF to 300.04fF |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 1.837e-04A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 331.9ps, Power: 1.866e-03W (max), 6.267e-05W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 2797.0ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -1.513843e-06W/°C |
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 1.837143e-04A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 331.9ps

  - Maximum Switching Power: 1.866241e-03W

  - Average Switching Power: 6.267408e-05W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 659.4ps

  - Stage 2 Delay: 1474.8ps

  - Stage 3 Delay: 662.8ps

  - Total Delay: 2797.0ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 1.866241e-03W

  - Maximum Power at 100°C: 1.755730e-03W

  - Average Power at 27°C: 6.267408e-05W

  - Average Power at 100°C: 6.971524e-05W

  - Power Temperature Coefficient: -1.513843e-06W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 51.19fF to 300.04fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Cgg_ls: 168.392800 fF
  - Cgs_ls: -39.698033 fF
  - Cgd_ls: -27.199183 fF
  - Cgb_ls: -101.495500 fF
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 16.839280 fF/µm²
    - Cgs_ls/Area: -3.969803 fF/µm²
    - Cgd_ls/Area: -2.719918 fF/µm²
    - Cgb_ls/Area: -10.149550 fF/µm²
...
- Started: `2026-07-26T21:59:38.389998+00:00`
- Finished: `2026-07-26T22:01:54.839649+00:00`
- Elapsed seconds: `136.449644`
- Peak resident memory KiB: `196980`
