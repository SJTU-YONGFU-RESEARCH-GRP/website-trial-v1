...
Generated on: 2026-07-27 10:21:03
...
- [<span style='color: green'>✓</span>] Circuit file exists and is readable
  - Path: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/fa504e9e4e0451bde2e4ee4397e0935f/ngspice/_ngspice_netlists/dc_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/fa504e9e4e0451bde2e4ee4397e0935f/ngspice/_ngspice_netlists/transient_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/fa504e9e4e0451bde2e4ee4397e0935f/ngspice/_ngspice_netlists/noise_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/fa504e9e4e0451bde2e4ee4397e0935f/ngspice/_ngspice_netlists/ac_circuit.cir
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 42.93fF to 214.77fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -29dB to -26dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.401 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 4.180e-04A, Rise Time: 0.0ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 135.2ps, Power: 2.591e-05W (max), 1.144e-06W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 201.1ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -4.091724e-08W/°C |
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 4.180329e-04A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 135.2ps

  - Maximum Switching Power: 2.590940e-05W

  - Average Switching Power: 1.144163e-06W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 135.2ps

  - Stage 2 Delay: 44.1ps

  - Stage 3 Delay: 21.9ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 2.590940e-05W

  - Maximum Power at 100°C: 2.292244e-05W

  - Average Power at 27°C: 1.144163e-06W

  - Average Power at 100°C: 1.030274e-06W

  - Power Temperature Coefficient: -4.091724e-08W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 42.93fF to 214.77fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 12.200545 fF/µm²
    - Cgs_ls/Area: -2.534806 fF/µm²
    - Cgd_ls/Area: -1.759775 fF/µm²
    - Cgb_ls/Area: -7.905978 fF/µm²
...
- Started: `2026-07-27T02:20:16.762102+00:00`
- Finished: `2026-07-27T02:21:03.722896+00:00`
- Elapsed seconds: `46.960809`
- Peak resident memory KiB: `203624`
