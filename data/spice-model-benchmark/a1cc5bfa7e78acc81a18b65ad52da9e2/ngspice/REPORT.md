...
Generated on: 2026-07-27 06:02:05
...
- [<span style='color: green'>✓</span>] Circuit file exists and is readable
  - Path: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/a1cc5bfa7e78acc81a18b65ad52da9e2/ngspice/_ngspice_netlists/dc_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/a1cc5bfa7e78acc81a18b65ad52da9e2/ngspice/_ngspice_netlists/transient_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/a1cc5bfa7e78acc81a18b65ad52da9e2/ngspice/_ngspice_netlists/noise_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/a1cc5bfa7e78acc81a18b65ad52da9e2/ngspice/_ngspice_netlists/ac_circuit.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -7.09e-04A to 0.00e+00A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -5.19e-04A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 5.19e-04A, IB: 0.00e+00A to 1.20e-15A, KCL Error: 0.00%, Power: 0.00e+00W to 6.23e-04W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000000 /°C, IDS: -7.091e-04A to 0.000e+00A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 8.509e-04W, Efficiency: 2.249e+00 to 5.156e+10, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 24.06fF to 83.94fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -23dB to -23dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.86 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 4.758e-05A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 432.4ps, Power: 1.847e-03W (max), 7.399e-05W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 3079.1ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -1.446342e-06W/°C |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -5.19e-04A to 0.00e+00A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: 0.00e+00A to 5.19e-04A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -7.091e-04A to 0.000e+00A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 8.509e-04W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 2.249e+00 to 5.156e+10
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 4.758041e-05A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 432.4ps

  - Maximum Switching Power: 1.846600e-03W

  - Average Switching Power: 7.399074e-05W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 722.5ps

  - Stage 2 Delay: 1709.5ps

  - Stage 3 Delay: 647.1ps

  - Total Delay: 3079.1ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 1.846600e-03W

  - Maximum Power at 100°C: 1.741017e-03W

  - Average Power at 27°C: 7.399074e-05W

  - Average Power at 100°C: 7.517346e-05W

  - Power Temperature Coefficient: -1.446342e-06W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 24.06fF to 83.94fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 5.319130 fF/µm²
    - Cgs_ls/Area: -1.148932 fF/µm²
    - Cgd_ls/Area: -0.804115 fF/µm²
    - Cgb_ls/Area: -3.366083 fF/µm²
...
- Started: `2026-07-26T22:00:19.681875+00:00`
- Finished: `2026-07-26T22:02:06.419660+00:00`
- Elapsed seconds: `106.73778`
- Peak resident memory KiB: `192900`
