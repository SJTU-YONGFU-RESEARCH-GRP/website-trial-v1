...
Generated on: 2026-07-30 01:03:01
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/a027fb5803148e83aab109b4c0b22e97/ngspice/netlist/dc.cir
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/a027fb5803148e83aab109b4c0b22e97/ngspice/netlist/transient.cir
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/a027fb5803148e83aab109b4c0b22e97/ngspice/netlist/ac.cir
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/a027fb5803148e83aab109b4c0b22e97/ngspice/netlist/noise.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -5.38e-04A to 1.34e-51A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -4.51e-04A to -3.43e-54A, IG: 0.00e+00A to 0.00e+00A, IS: -2.08e-42A to 4.51e-04A, IB: 7.54e-54A to 1.22e-11A, KCL Error: 0.00%, Power: 0.00e+00W to 5.41e-04W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000000 /°C, IDS: -5.383e-04A to 1.340e-51A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 6.459e-04W, Efficiency: 1.536e+00 to 8.713e+11, TC: 2.28e-02/°C |
...
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.871 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 3.768e-05A, Rise Time: 400ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 147.251ps (sample interval 10ps), Power: 7.731e-05W (max), 3.256e-06W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 1283.37ps (sample interval 10ps) |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: 1.931045e-08W/°C |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -4.51e-04A to -3.43e-54A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: -2.08e-42A to 4.51e-04A
  - IB: 7.54e-54A to 1.22e-11A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -5.383e-04A to 1.340e-51A
...
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 1.536e+00 to 8.713e+11
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: 2.28e-02/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 3.768381e-05A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 147.251ps
  - Transient sample interval: 10ps

  - Maximum Switching Power: 7.731202e-05W

  - Average Switching Power: 3.255780e-06W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 298.892ps

  - Stage 2 Delay: 618.699ps

  - Stage 3 Delay: 345.372ps

  - Total Delay: 1283.37ps
  - Transient sample interval: 10ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 7.731202e-05W

  - Maximum Power at 100°C: 7.872168e-05W

  - Average Power at 27°C: 3.255780e-06W

  - Average Power at 100°C: 3.788693e-06W

  - Power Temperature Coefficient: 1.931045e-08W/°C
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 4.331100 fF/µm²
    - Cgs_ls/Area: -1.335862 fF/µm²
    - Cgd_ls/Area: -0.963939 fF/µm²
    - Cgb_ls/Area: -2.031300 fF/µm²
...
- [<span style='color: green'>✓</span>] S-parameter analysis verified
  ...
  - S12 range: -117.054dB to -57.0608dB
  - S22 range: -0.00322306dB to -0.00299715dB
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.9993236070588332
...
- Started: `2026-07-29T16:59:05.091425+00:00`
- Finished: `2026-07-29T17:03:17.854697+00:00`
- Elapsed seconds: `252.763278`
- Peak resident memory KiB: `222368`
