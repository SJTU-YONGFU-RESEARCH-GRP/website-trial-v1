...
Generated on: 2026-07-29 00:03:27
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/1bfcaa51cb5eb8da4ab39d44541e0a8c/spectre/netlist/dc.scs
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/1bfcaa51cb5eb8da4ab39d44541e0a8c/spectre/netlist/transient.scs
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/1bfcaa51cb5eb8da4ab39d44541e0a8c/spectre/netlist/ac.scs
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/1bfcaa51cb5eb8da4ab39d44541e0a8c/spectre/netlist/noise.scs
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: -1.20V to 0.00V, VGS: -1.20V to 0.00V, IDS: 0.00e+00A to 2.02e-06A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: 0.00e+00A to 6.80e-07A, IG: 0.00e+00A to 0.00e+00A, IS: -6.80e-07A to 0.00e+00A, IB: -1.20e-12A to 0.00e+00A, KCL Error: 0.00%, Power: 0.00e+00W to 8.16e-07W, Temp: -40.0°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000000 /°C, IDS: 0.000e+00A to 2.025e-06A |
...
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 168.65° |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 7.041e-07A, Rise Time: 0.0ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 181.8ps, Power: 1.162e-06W (max), 1.430e-07W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 3971.5ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: 1.433808e-08W/°C |
...
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 1.13e-04 V²/Hz, Variation: 0.0000 |
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: 0.000e+00A to 2.025e-06A
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 7.040879e-07A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 181.8ps

  - Maximum Switching Power: 1.162427e-06W

  - Average Switching Power: 1.430042e-07W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 197.8ps

  - Stage 2 Delay: 2248.9ps

  - Stage 3 Delay: 1524.8ps

  - Total Delay: 3971.5ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 1.162427e-06W

  - Maximum Power at 100°C: 2.209107e-06W

  - Average Power at 27°C: 1.430042e-07W

  - Average Power at 100°C: 2.931071e-07W

  - Power Temperature Coefficient: 1.433808e-08W/°C
...
- [<span style='color: green'>✓</span>] Flicker noise analysis completed
  ...
  - Exponent (γ): 2.93e-16 (ideally -1.0 for pure 1/f noise)
  - Correlation (R²): -7.7000
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.9975703589618908
...
- Started: `2026-07-28T16:01:51.850870+00:00`
- Finished: `2026-07-28T16:04:12.655624+00:00`
- Elapsed seconds: `140.804754`
- Peak resident memory KiB: `239060`
