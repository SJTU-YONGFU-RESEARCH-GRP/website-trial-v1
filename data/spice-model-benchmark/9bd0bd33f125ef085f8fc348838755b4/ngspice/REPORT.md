...
Generated on: 2026-07-28 23:22:52
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/9bd0bd33f125ef085f8fc348838755b4/ngspice/netlist/dc.cir
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/9bd0bd33f125ef085f8fc348838755b4/ngspice/netlist/transient.cir
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/9bd0bd33f125ef085f8fc348838755b4/ngspice/netlist/ac.cir
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/9bd0bd33f125ef085f8fc348838755b4/ngspice/netlist/noise.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -1.42e-04A to 4.52e-28A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -1.30e-04A to 9.74e-33A, IG: -1.73e-18A to 1.73e-18A, IS: -3.11e-36A to 1.30e-04A, IB: -1.95e-32A to 1.45e-15A, KCL Error: 0.00%, Power: 0.00e+00W to 1.56e-04W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: -0.000000 /°C, IDS: -1.424e-04A to 4.524e-28A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 1.709e-04W, Efficiency: 5.652e+00 to 2.460e+11, TC: nan/°C |
...
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.834 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 3.707e-06A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 240.0ps, Power: 7.626e-05W (max), 7.180e-07W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 686.2ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: 1.654207e-08W/°C |
...
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 3.32e-06 V²/Hz, Variation: 1.9037 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -1.30e-04A to 9.74e-33A
  - IG: -1.73e-18A to 1.73e-18A
  - IS: -3.11e-36A to 1.30e-04A
  - IB: -1.95e-32A to 1.45e-15A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -1.424e-04A to 4.524e-28A
...
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 5.652e+00 to 2.460e+11
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 3.706886e-06A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  ...
  - Maximum Switching Power: 7.626451e-05W

  - Average Switching Power: 7.180100e-07W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 277.3ps

  - Stage 2 Delay: 218.9ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 7.626451e-05W

  - Maximum Power at 100°C: 7.747208e-05W

  - Average Power at 27°C: 7.180100e-07W

  - Average Power at 100°C: 7.115786e-07W

  - Power Temperature Coefficient: 1.654207e-08W/°C
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 2.350063 fF/µm²
    - Cgs_ls/Area: -0.708864 fF/µm²
    - Cgd_ls/Area: -0.767012 fF/µm²
    - Cgb_ls/Area: -0.874187 fF/µm²
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 3.32e-06 V²/Hz
  - Standard Deviation: 6.32e-06 V²/Hz
  - Variation Coefficient: 1.9037
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.9989296819399649
...
- Model: `sky130__fd__pr__rf__nfet__g5v0d10v5__bm02__model__expansion_translation`
- Model MD5: `9bd0bd33f125ef085f8fc348838755b4`
- Simulator: `ngspice`
- Modes: `dc, transient, ac, noise`
- Started: `2026-07-28T14:42:19.341574+00:00`
- Finished: `2026-07-28T15:23:29.700360+00:00`
- Elapsed seconds: `2470.358798`
- Peak resident memory KiB: `225896`
