...
Generated on: 2026-07-28 22:43:45
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/9bd0bd33f125ef085f8fc348838755b4/spectre/netlist/dc.scs
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/9bd0bd33f125ef085f8fc348838755b4/spectre/netlist/transient.scs
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/9bd0bd33f125ef085f8fc348838755b4/spectre/netlist/ac.scs
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/9bd0bd33f125ef085f8fc348838755b4/spectre/netlist/noise.scs
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -1.42e-04A to 1.43e-16A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -1.30e-04A to 0.00e+00A, IG: 0.00e+00A to 3.40e-25A, IS: 0.00e+00A to 1.30e-04A, IB: 0.00e+00A to 1.20e-12A, KCL Error: 0.00%, Power: 0.00e+00W to 1.56e-04W, Temp: -40.0°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: -0.000000 /°C, IDS: -1.424e-04A to 1.427e-16A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 1.709e-04W, Efficiency: 5.652e+00 to 6.080e+10, TC: nan/°C |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 3.716e-06A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 243.0ps, Power: 7.842e-05W (max), 6.112e-06W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 770.8ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -2.615252e-08W/°C |
...
| [Flicker (1/f) Noise](#flicker-noise-analysis) | <span style='color: green'>✓</span> | Exponent: 0.2182, Corner Freq: not resolved |
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 1.17e-03 V²/Hz, Variation: 1.1418 |
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -1.424e-04A to 1.427e-16A
...
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 5.652e+00 to 6.080e+10
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 3.716168e-06A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 243.0ps

  - Maximum Switching Power: 7.842226e-05W

  - Average Switching Power: 6.112304e-06W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 291.4ps

  - Stage 2 Delay: 253.2ps

  - Stage 3 Delay: 226.2ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 7.842226e-05W

  - Maximum Power at 100°C: 7.651313e-05W

  - Average Power at 27°C: 6.183567e-06W

  - Average Power at 100°C: 5.883376e-06W

  - Power Temperature Coefficient: -2.615252e-08W/°C
...
- [<span style='color: green'>✓</span>] Flicker noise analysis completed
  - Coefficient (K): 8.58e-04
  - Exponent (γ): 2.18e-01 (ideally -1.0 for pure 1/f noise)
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 1.17e-03 V²/Hz
  - Standard Deviation: 1.33e-03 V²/Hz
  - Variation Coefficient: 1.1418
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.9975703404002968
...
- Started: `2026-07-28T14:42:37.048986+00:00`
- Finished: `2026-07-28T14:44:18.502973+00:00`
- Elapsed seconds: `101.453999`
- Peak resident memory KiB: `239728`
