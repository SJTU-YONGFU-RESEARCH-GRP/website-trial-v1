...
Generated on: 2026-07-28 23:16:53
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/2c9ed8d077bf83bed597c7fcb0d35e93/spectre/netlist/dc.scs
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/2c9ed8d077bf83bed597c7fcb0d35e93/spectre/netlist/transient.scs
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/2c9ed8d077bf83bed597c7fcb0d35e93/spectre/netlist/ac.scs
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/2c9ed8d077bf83bed597c7fcb0d35e93/spectre/netlist/noise.scs
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: -1.20V to 0.00V, VGS: -1.20V to 0.00V, IDS: -8.68e-18A to 1.27e-04A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -1.76e-20A to 7.14e-05A, IG: -1.51e-24A to 1.54e-27A, IS: -7.14e-05A to 1.76e-20A, IB: -3.14e-12A to 3.03e-26A, KCL Error: 0.00%, Power: 0.00e+00W to 8.57e-05W, Temp: -40.0°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000000 /°C, IDS: -8.676e-18A to 1.271e-04A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 1.526e-04W, Efficiency: 5.787e+00 to 1.068e+11, TC: nan/°C |
...
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.69° |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 7.556e-05A, Rise Time: 0.0ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 244.9ps, Power: 6.354e-05W (max), 4.057e-06W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 767.3ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: 5.744614e-08W/°C |
...
| [Flicker (1/f) Noise](#flicker-noise-analysis) | <span style='color: green'>✓</span> | Exponent: 0.2088, Corner Freq: not resolved |
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 5.03e-04 V²/Hz, Variation: 1.1405 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -1.76e-20A to 7.14e-05A
  - IG: -1.51e-24A to 1.54e-27A
  - IS: -7.14e-05A to 1.76e-20A
  - IB: -3.14e-12A to 3.03e-26A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -8.676e-18A to 1.271e-04A
...
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 5.787e+00 to 1.068e+11
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 7.555551e-05A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 244.9ps

  - Maximum Switching Power: 6.354067e-05W

  - Average Switching Power: 4.057197e-06W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 298.8ps

  - Stage 2 Delay: 277.1ps

  - Stage 3 Delay: 191.5ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 6.354067e-05W

  - Maximum Power at 100°C: 6.773424e-05W

  - Average Power at 27°C: 4.055789e-06W

  - Average Power at 100°C: 4.387834e-06W

  - Power Temperature Coefficient: 5.744614e-08W/°C
...
- [<span style='color: green'>✓</span>] Flicker noise analysis completed
  - Coefficient (K): 4.71e-04
  - Exponent (γ): 2.09e-01 (ideally -1.0 for pure 1/f noise)
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 5.03e-04 V²/Hz
  - Standard Deviation: 5.74e-04 V²/Hz
  - Variation Coefficient: 1.1405
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.9975703131226812
...
- Started: `2026-07-28T15:15:30.047650+00:00`
- Finished: `2026-07-28T15:17:31.275765+00:00`
- Elapsed seconds: `121.228124`
- Peak resident memory KiB: `222324`
