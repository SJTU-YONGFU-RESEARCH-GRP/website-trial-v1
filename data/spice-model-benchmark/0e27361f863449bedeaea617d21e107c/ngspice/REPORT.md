...
Generated on: 2026-07-28 23:43:37
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/0e27361f863449bedeaea617d21e107c/ngspice/netlist/dc.cir
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/0e27361f863449bedeaea617d21e107c/ngspice/netlist/transient.cir
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/0e27361f863449bedeaea617d21e107c/ngspice/netlist/ac.cir
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/0e27361f863449bedeaea617d21e107c/ngspice/netlist/noise.cir
...
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -9.13e-05A to 0.00e+00A, IG: 0.00e+00A to 1.73e-18A, IS: 0.00e+00A to 9.13e-05A, IB: 0.00e+00A to 1.20e-15A, KCL Error: 0.00%, Power: 0.00e+00W to 1.10e-04W, Temp: -40°C |
...
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 1.544e-04W, Efficiency: 6.065e+00 to 2.083e+10, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 7.94fF to 11.04fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -55dB to -52dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.409 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 6.123e-06A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 291.0ps, Power: 7.658e-05W (max), 8.825e-07W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 1005.2ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: 1.705937e-08W/°C |
...
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 9.95e-07 V²/Hz, Variation: 2.0378 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -9.13e-05A to 0.00e+00A
  - IG: 0.00e+00A to 1.73e-18A
  - IS: 0.00e+00A to 9.13e-05A
...
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 6.065e+00 to 2.083e+10
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 6.123174e-06A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 291.0ps

  - Maximum Switching Power: 7.658482e-05W

  - Average Switching Power: 8.825066e-07W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 361.0ps

  - Stage 2 Delay: 330.0ps

  - Stage 3 Delay: 314.1ps

  - Total Delay: 1005.2ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 7.658482e-05W

  - Maximum Power at 100°C: 7.783015e-05W

  - Average Power at 27°C: 8.825066e-07W

  - Average Power at 100°C: 8.606471e-07W

  - Power Temperature Coefficient: 1.705937e-08W/°C
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 2.495222 fF/µm²
    - Cgs_ls/Area: -0.883715 fF/µm²
    - Cgd_ls/Area: -0.806318 fF/µm²
    - Cgb_ls/Area: -0.805189 fF/µm²
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 9.95e-07 V²/Hz
  - Standard Deviation: 2.03e-06 V²/Hz
  - Variation Coefficient: 2.0378
...
- Model: `sky130__fd__pr__rf__nfet__g5v0d10v5__bm10__model__fitting_reduction_translation`
- Model MD5: `0e27361f863449bedeaea617d21e107c`
- Simulator: `ngspice`
- Modes: `dc, transient, ac, noise`
- Started: `2026-07-28T15:01:29.720285+00:00`
- Finished: `2026-07-28T15:44:19.502538+00:00`
- Elapsed seconds: `2569.782272`
- Peak resident memory KiB: `238988`
