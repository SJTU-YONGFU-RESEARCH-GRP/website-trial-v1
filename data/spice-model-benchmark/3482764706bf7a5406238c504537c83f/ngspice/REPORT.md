...
Generated on: 2026-07-29 00:14:35
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/3482764706bf7a5406238c504537c83f/ngspice/netlist/dc.cir
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/3482764706bf7a5406238c504537c83f/ngspice/netlist/transient.cir
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/3482764706bf7a5406238c504537c83f/ngspice/netlist/ac.cir
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/3482764706bf7a5406238c504537c83f/ngspice/netlist/noise.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -2.24e-05A to 2.50e-22A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -2.04e-05A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 2.04e-05A, IB: 0.00e+00A to 1.12e-14A, KCL Error: 0.00%, Power: 0.00e+00W to 2.45e-05W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: -0.000000 /°C, IDS: -2.241e-05A to 2.501e-22A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 2.689e-05W, Efficiency: 2.620e+01 to 1.966e+10, TC: nan/°C |
...
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.945 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 3.997e-07A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 230.0ps, Power: 3.092e-05W (max), 1.056e-07W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 421.0ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -6.749086e-08W/°C |
...
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 1.45e-08 V²/Hz, Variation: 0.0000 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -2.04e-05A to 0.00e+00A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: 0.00e+00A to 2.04e-05A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -2.241e-05A to 2.501e-22A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 2.689e-05W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 2.620e+01 to 1.966e+10
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 3.997253e-07A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  ...
  - Maximum Switching Power: 3.092085e-05W

  - Average Switching Power: 1.055623e-07W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  ...
  - Stage 2 Delay: 93.6ps

  - Stage 3 Delay: 78.8ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 3.092085e-05W

  - Maximum Power at 100°C: 2.599402e-05W

  - Average Power at 27°C: 1.055623e-07W

  - Average Power at 100°C: 9.548891e-08W

  - Power Temperature Coefficient: -6.749086e-08W/°C
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 6.272279 fF/µm²
    - Cgs_ls/Area: -2.739035 fF/µm²
    - Cgd_ls/Area: -2.595195 fF/µm²
    - Cgb_ls/Area: -0.938048 fF/µm²
...
- [<span style='color: green'>✓</span>] Flicker noise analysis completed
  ...
  - Exponent (γ): -4.01e-16 (ideally -1.0 for pure 1/f noise)
  - Correlation (R²): -0.5222
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Standard Deviation: 1.86e-24 V²/Hz
...
- Model: `sky130__fd__pr__special__nfet__pass__flash__model__reduction`
- Model MD5: `3482764706bf7a5406238c504537c83f`
- Simulator: `ngspice`
- Modes: `dc, transient, ac, noise`
- Started: `2026-07-28T15:34:22.123968+00:00`
- Finished: `2026-07-28T16:15:11.387168+00:00`
- Elapsed seconds: `2449.263205`
- Peak resident memory KiB: `216240`
