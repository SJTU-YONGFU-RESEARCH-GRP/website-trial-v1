...
Generated on: 2026-07-27 10:18:44
...
- [<span style='color: green'>✓</span>] Circuit file exists and is readable
  - Path: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/7bbc30c68f9c8749c3d9e988d5daafdf/ngspice/_ngspice_netlists/dc_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/7bbc30c68f9c8749c3d9e988d5daafdf/ngspice/_ngspice_netlists/transient_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/7bbc30c68f9c8749c3d9e988d5daafdf/ngspice/_ngspice_netlists/noise_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/7bbc30c68f9c8749c3d9e988d5daafdf/ngspice/_ngspice_netlists/ac_circuit.cir
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 47.50fF to 300.93fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -34dB to -27dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 178.72 |
...
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 152.2ps, Power: 2.562e-05W (max), 1.008e-06W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 219.0ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -3.877096e-08W/°C |
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 3.468422e-04A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 152.2ps

  - Maximum Switching Power: 2.561923e-05W

  - Average Switching Power: 1.007528e-06W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 152.2ps

  - Stage 2 Delay: 45.3ps

  - Stage 3 Delay: 21.5ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 2.561923e-05W

  - Maximum Power at 100°C: 2.278895e-05W

  - Average Power at 27°C: 1.007528e-06W

  - Average Power at 100°C: 9.187673e-07W

  - Power Temperature Coefficient: -3.877096e-08W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 47.50fF to 300.93fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Cgg_ls: 154.472950 fF
  - Cgs_ls: -29.716195 fF
  - Cgd_ls: -20.483545 fF
  - Cgb_ls: -104.273200 fF
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 15.447295 fF/µm²
    - Cgs_ls/Area: -2.971620 fF/µm²
    - Cgd_ls/Area: -2.048355 fF/µm²
    - Cgb_ls/Area: -10.427320 fF/µm²
...
- Started: `2026-07-27T02:17:30.284359+00:00`
- Finished: `2026-07-27T02:18:44.860942+00:00`
- Elapsed seconds: `74.576461`
- Peak resident memory KiB: `199368`
