...
Generated on: 2026-07-28 23:13:28
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/4ae35efc94c3b9110ae93069788f27e2/ngspice/netlist/dc.cir
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/4ae35efc94c3b9110ae93069788f27e2/ngspice/netlist/transient.cir
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/4ae35efc94c3b9110ae93069788f27e2/ngspice/netlist/ac.cir
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/4ae35efc94c3b9110ae93069788f27e2/ngspice/netlist/noise.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -9.38e-04A to 0.00e+00A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -8.01e-04A to 0.00e+00A, IG: -8.67e-18A to 3.47e-18A, IS: 0.00e+00A to 8.01e-04A, IB: 0.00e+00A to 1.20e-15A, KCL Error: 0.00%, Power: 0.00e+00W to 9.62e-04W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000000 /°C, IDS: -9.378e-04A to 0.000e+00A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 1.125e-03W, Efficiency: 3.047e+00 to 9.107e+11, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 6.33fF to 10.91fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -19dB to -19dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.981 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 5.803e-06A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 80.0ps, Power: 7.598e-05W (max), 5.498e-07W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 368.9ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -2.860779e-08W/°C |
...
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 2.74e-05 V²/Hz, Variation: 2.2900 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -8.01e-04A to 0.00e+00A
  - IG: -8.67e-18A to 3.47e-18A
  - IS: 0.00e+00A to 8.01e-04A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -9.378e-04A to 0.000e+00A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 1.125e-03W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 3.047e+00 to 9.107e+11
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 5.803442e-06A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  ...
  - Maximum Switching Power: 7.597651e-05W

  - Average Switching Power: 5.498347e-07W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 127.2ps

  - Stage 2 Delay: 165.1ps

  - Stage 3 Delay: 76.6ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 7.597651e-05W

  - Maximum Power at 100°C: 7.388815e-05W

  - Average Power at 27°C: 5.498347e-07W

  - Average Power at 100°C: 5.332657e-07W

  - Power Temperature Coefficient: -2.860779e-08W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 6.33fF to 10.91fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 6.544117 fF/µm²
    - Cgs_ls/Area: -2.083636 fF/µm²
    - Cgd_ls/Area: -2.682542 fF/µm²
    - Cgb_ls/Area: -1.777937 fF/µm²
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 2.74e-05 V²/Hz
  - Standard Deviation: 6.28e-05 V²/Hz
...
- Model: `sky130__fd__pr__rf__nfet__01v8__lvt__bm02__model__fitting_reduction_translation`
- Model MD5: `4ae35efc94c3b9110ae93069788f27e2`
- Simulator: `ngspice`
- Modes: `dc, transient, ac, noise`
- Started: `2026-07-28T14:29:23.467634+00:00`
- Finished: `2026-07-28T15:14:08.198792+00:00`
- Elapsed seconds: `2684.73116`
- Peak resident memory KiB: `233480`
