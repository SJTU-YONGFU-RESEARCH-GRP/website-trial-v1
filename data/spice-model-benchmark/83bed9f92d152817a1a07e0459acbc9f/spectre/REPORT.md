...
Generated on: 2026-07-28 20:18:54
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/83bed9f92d152817a1a07e0459acbc9f/spectre/netlist/dc.scs
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/83bed9f92d152817a1a07e0459acbc9f/spectre/netlist/transient.scs
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/83bed9f92d152817a1a07e0459acbc9f/spectre/netlist/ac.scs
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/83bed9f92d152817a1a07e0459acbc9f/spectre/netlist/noise.scs
...
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -1.66e-04A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 1.66e-04A, IB: 0.00e+00A to 1.21e-12A, KCL Error: 0.00%, Power: 0.00e+00W to 2.00e-04W, Temp: -40.0°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000000 /°C, IDS: -2.176e-04A to 0.000e+00A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 2.611e-04W, Efficiency: 2.978e-01 to 8.282e+08, TC: nan/°C |
...
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.45° |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 3.151e-05A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 263.5ps, Power: 7.947e-05W (max), 7.723e-06W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 2200.9ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -2.338712e-08W/°C |
...
| [Flicker (1/f) Noise](#flicker-noise-analysis) | <span style='color: green'>✓</span> | Exponent: 0.2495, Corner Freq: not resolved |
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 3.06e-04 V²/Hz, Variation: 1.0374 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -1.66e-04A to 0.00e+00A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: 0.00e+00A to 1.66e-04A
  - IB: 0.00e+00A to 1.21e-12A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -2.176e-04A to 0.000e+00A
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 3.150794e-05A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 263.5ps

  - Maximum Switching Power: 7.947305e-05W

  - Average Switching Power: 7.723126e-06W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 761.9ps

  - Stage 2 Delay: 1243.8ps

  - Stage 3 Delay: 195.1ps

  - Total Delay: 2200.9ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 7.947305e-05W

  - Maximum Power at 100°C: 7.776579e-05W

  - Average Power at 27°C: 7.723126e-06W

  - Average Power at 100°C: 8.382147e-06W

  - Power Temperature Coefficient: -2.338712e-08W/°C
...
- [<span style='color: green'>✓</span>] Flicker noise analysis completed
  - Coefficient (K): 2.40e-03
  - Exponent (γ): 2.49e-01 (ideally -1.0 for pure 1/f noise)
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 3.06e-04 V²/Hz
  - Standard Deviation: 3.18e-04 V²/Hz
  - Variation Coefficient: 1.0374
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.9975703529229044
...
- Started: `2026-07-28T12:17:46.228250+00:00`
- Finished: `2026-07-28T12:19:17.263738+00:00`
- Elapsed seconds: `91.035498`
- Peak resident memory KiB: `222396`
