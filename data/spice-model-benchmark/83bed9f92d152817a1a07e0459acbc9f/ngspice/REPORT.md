...
Generated on: 2026-07-28 20:18:12
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/83bed9f92d152817a1a07e0459acbc9f/ngspice/netlist/dc.cir
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/83bed9f92d152817a1a07e0459acbc9f/ngspice/netlist/transient.cir
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/83bed9f92d152817a1a07e0459acbc9f/ngspice/netlist/ac.cir
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/83bed9f92d152817a1a07e0459acbc9f/ngspice/netlist/noise.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -2.18e-04A to 8.80e-38A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -1.66e-04A to 1.01e-42A, IG: 0.00e+00A to 0.00e+00A, IS: 1.52e-42A to 1.66e-04A, IB: -2.54e-42A to 7.40e-15A, KCL Error: 0.00%, Power: 0.00e+00W to 2.00e-04W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000000 /°C, IDS: -2.176e-04A to 8.796e-38A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 2.611e-04W, Efficiency: 2.978e-01 to 8.282e+08, TC: 7.16e-03/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 28.09fF to 79.31fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -34dB to -32dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.452 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 3.150e-05A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 264.2ps, Power: 7.748e-05W (max), 1.128e-06W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 2140.3ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: 2.106446e-08W/°C |
...
| [Flicker (1/f) Noise](#flicker-noise-analysis) | <span style='color: green'>✓</span> | Exponent: 0.4989, Corner Freq: not resolved |
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 3.86e-07 V²/Hz, Variation: 1.9750 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -1.66e-04A to 1.01e-42A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: 1.52e-42A to 1.66e-04A
  - IB: -2.54e-42A to 7.40e-15A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -2.176e-04A to 8.796e-38A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 2.611e-04W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 2.978e-01 to 8.282e+08
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: 7.16e-03/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 3.149668e-05A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 264.2ps

  - Maximum Switching Power: 7.747639e-05W

  - Average Switching Power: 1.128235e-06W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 749.7ps

  - Stage 2 Delay: 1200.6ps

  - Stage 3 Delay: 190.0ps

  - Total Delay: 2140.3ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 7.747639e-05W

  - Maximum Power at 100°C: 7.901409e-05W

  - Average Power at 27°C: 1.128235e-06W

  - Average Power at 100°C: 1.365629e-06W

  - Power Temperature Coefficient: 2.106446e-08W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 28.09fF to 79.31fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    - Geometry: W=9.9975 µm, L=4.0025 µm, Area=40.015 µm²
    - Cgg_ls/Area: 1.256788 fF/µm²
    - Cgs_ls/Area: -0.508526 fF/µm²
    - Cgd_ls/Area: -0.362168 fF/µm²
    - Cgb_ls/Area: -0.386094 fF/µm²
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 3.86e-07 V²/Hz
  - Standard Deviation: 7.63e-07 V²/Hz
  - Variation Coefficient: 1.9750
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.998929681939812
...
- Model: `sky130__fd__pr__cap__vpp__11p3x11p8__l1m1m2m3m4__shieldm5__nhv__base__model__expansion_translation`
- Model MD5: `83bed9f92d152817a1a07e0459acbc9f`
- Simulator: `ngspice`
- Modes: `dc, transient, ac, noise`
- Started: `2026-07-28T12:17:33.902593+00:00`
- Finished: `2026-07-28T12:18:38.937554+00:00`
- Elapsed seconds: `65.034985`
- Peak resident memory KiB: `223576`
