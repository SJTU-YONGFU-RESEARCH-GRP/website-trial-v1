...
Generated on: 2026-07-28 20:17:30
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/f1e2cfd6e5626a9349961aff4ca56020/ngspice/netlist/dc.cir
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/f1e2cfd6e5626a9349961aff4ca56020/ngspice/netlist/transient.cir
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/f1e2cfd6e5626a9349961aff4ca56020/ngspice/netlist/ac.cir
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/f1e2cfd6e5626a9349961aff4ca56020/ngspice/netlist/noise.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -1.33e-04A to 1.41e-20A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -1.18e-04A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 1.18e-04A, IB: 0.00e+00A to 1.12e-14A, KCL Error: 0.00%, Power: 0.00e+00W to 1.42e-04W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000000 /°C, IDS: -1.335e-04A to 1.414e-20A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 1.602e-04W, Efficiency: 9.192e+00 to 3.322e+05, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 1.43fF to 1.57fF |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: -3.538e-05A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 10719.9ps, Power: 6.903e-05W (max), 1.957e-05W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 10822.8ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -2.719624e-08W/°C |
...
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 1.77e-08 V²/Hz, Variation: 0.0000 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -1.18e-04A to 0.00e+00A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: 0.00e+00A to 1.18e-04A
  - IB: 0.00e+00A to 1.12e-14A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -1.335e-04A to 1.414e-20A
...
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 9.192e+00 to 3.322e+05
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: -3.537768e-05A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 10719.9ps

  - Maximum Switching Power: 6.903036e-05W

  - Average Switching Power: 1.956755e-05W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 10747.4ps

  - Stage 2 Delay: 142.3ps

  - Stage 3 Delay: 10812.8ps

  - Total Delay: 10822.8ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 6.903036e-05W

  - Maximum Power at 100°C: 6.704503e-05W

  - Average Power at 27°C: 1.956755e-05W

  - Average Power at 100°C: 2.171569e-05W

  - Power Temperature Coefficient: -2.719624e-08W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 1.43fF to 1.57fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 2.978715 fF/µm²
    - Cgs_ls/Area: -1.474883 fF/µm²
    - Cgd_ls/Area: -1.248379 fF/µm²
    - Cgb_ls/Area: -0.255451 fF/µm²
...
- [<span style='color: green'>✓</span>] Flicker noise analysis completed
  - Coefficient (K): 1.10e+02
  - Exponent (γ): -1.50e-16 (ideally -1.0 for pure 1/f noise)
  - Correlation (R²): 0.3968
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 1.77e-08 V²/Hz
  - Standard Deviation: 2.41e-24 V²/Hz
...
- Model: `sky130__fd__bs__flash__special__sonosfet__star__model__fitting_reduction_translation`
- Model MD5: `f1e2cfd6e5626a9349961aff4ca56020`
- Simulator: `ngspice`
- Modes: `dc, transient, ac, noise`
- Started: `2026-07-28T12:16:17.053906+00:00`
- Finished: `2026-07-28T12:17:53.797695+00:00`
- Elapsed seconds: `96.743824`
- Peak resident memory KiB: `225852`
