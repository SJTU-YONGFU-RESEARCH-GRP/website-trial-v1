...
Generated on: 2026-07-28 22:12:05
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/df07c8f070a8edcfb0f582e0a2959a50/ngspice/netlist/dc.cir
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/df07c8f070a8edcfb0f582e0a2959a50/ngspice/netlist/transient.cir
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/df07c8f070a8edcfb0f582e0a2959a50/ngspice/netlist/ac.cir
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/df07c8f070a8edcfb0f582e0a2959a50/ngspice/netlist/noise.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: -1.20V to 0.00V, VGS: -1.20V to 0.00V, IDS: -1.91e-37A to 2.01e-04A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -6.65e-44A to 1.80e-04A, IG: 0.00e+00A to 0.00e+00A, IS: -1.80e-04A to 4.65e-44A, IB: -1.22e-14A to 2.00e-44A, KCL Error: 0.00%, Power: 0.00e+00W to 2.16e-04W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000000 /°C, IDS: -1.907e-37A to 2.010e-04A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 2.412e-04W, Efficiency: 2.233e+00 to 7.586e+10, TC: 2.56e-02/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 20.57fF to 61.11fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -34dB to -33dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.684 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 2.305e-04A, Rise Time: 0.0ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 421.6ps, Power: 4.615e-04W (max), 1.818e-06W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 2410.7ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: 1.956082e-09W/°C |
...
| [Flicker (1/f) Noise](#flicker-noise-analysis) | <span style='color: green'>✓</span> | Exponent: 0.4371, Corner Freq: not resolved |
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 6.37e-07 V²/Hz, Variation: 1.8596 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -6.65e-44A to 1.80e-04A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: -1.80e-04A to 4.65e-44A
  - IB: -1.22e-14A to 2.00e-44A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -1.907e-37A to 2.010e-04A
...
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 2.233e+00 to 7.586e+10
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: 2.56e-02/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 2.304513e-04A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 421.6ps

  - Maximum Switching Power: 4.614615e-04W

  - Average Switching Power: 1.817535e-06W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 880.7ps

  - Stage 2 Delay: 1100.0ps

  - Stage 3 Delay: 430.0ps

  - Total Delay: 2410.7ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 4.614615e-04W

  - Maximum Power at 100°C: 4.616043e-04W

  - Average Power at 27°C: 1.817535e-06W

  - Average Power at 100°C: 1.656071e-06W

  - Power Temperature Coefficient: 1.956082e-09W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 20.57fF to 61.11fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 3.558542 fF/µm²
    - Cgs_ls/Area: -0.902682 fF/µm²
    - Cgd_ls/Area: -0.608556 fF/µm²
    - Cgb_ls/Area: -2.047304 fF/µm²
...
- [<span style='color: green'>✓</span>] S-parameter analysis verified
  ...
  - S21 range: -34dB to -33dB
  - S12 range: -138dB to -78dB
...
- [<span style='color: green'>✓</span>] Flicker noise analysis completed
  - Coefficient (K): 1.58e+04
  - Exponent (γ): 4.37e-01 (ideally -1.0 for pure 1/f noise)
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 6.37e-07 V²/Hz
  - Standard Deviation: 1.18e-06 V²/Hz
  - Variation Coefficient: 1.8596
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.99892968193981
...
- Model: `sky130__fd__pr__pfet__01v8__lvt__model__original`
- Model MD5: `df07c8f070a8edcfb0f582e0a2959a50`
- Simulator: `ngspice`
- Modes: `dc, transient, ac, noise`
- Started: `2026-07-28T13:27:49.521156+00:00`
- Finished: `2026-07-28T14:12:43.954358+00:00`
- Elapsed seconds: `2694.433217`
- Peak resident memory KiB: `221360`
