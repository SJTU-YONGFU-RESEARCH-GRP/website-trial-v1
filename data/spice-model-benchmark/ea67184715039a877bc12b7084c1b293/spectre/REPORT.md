...
Generated on: 2026-07-28 22:28:53
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/ea67184715039a877bc12b7084c1b293/spectre/netlist/dc.scs
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/ea67184715039a877bc12b7084c1b293/spectre/netlist/transient.scs
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/ea67184715039a877bc12b7084c1b293/spectre/netlist/ac.scs
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/ea67184715039a877bc12b7084c1b293/spectre/netlist/noise.scs
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -9.67e-04A to 1.15e-17A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -8.46e-04A to 3.80e-26A, IG: -1.98e-32A to 1.07e-26A, IS: -3.80e-26A to 8.46e-04A, IB: 0.00e+00A to 6.16e-11A, KCL Error: 0.00%, Power: 0.00e+00W to 1.02e-03W, Temp: -40.0°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000000 /°C, IDS: -9.666e-04A to 1.151e-17A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 1.160e-03W, Efficiency: 3.546e+00 to 1.204e+12, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 5.44fF to 9.54fF |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 4.538e-06A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 74.9ps, Power: 7.807e-05W (max), 4.799e-06W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 381.8ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -2.612333e-08W/°C |
...
| [Flicker (1/f) Noise](#flicker-noise-analysis) | <span style='color: green'>✓</span> | Exponent: 0.2998, Corner Freq: not resolved |
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 5.79e-04 V²/Hz, Variation: 1.4104 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -8.46e-04A to 3.80e-26A
  - IG: -1.98e-32A to 1.07e-26A
  - IS: -3.80e-26A to 8.46e-04A
  - IB: 0.00e+00A to 6.16e-11A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -9.666e-04A to 1.151e-17A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 1.160e-03W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 3.546e+00 to 1.204e+12
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 4.537928e-06A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 74.9ps

  - Maximum Switching Power: 7.806971e-05W

  - Average Switching Power: 4.799070e-06W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 116.5ps

  - Stage 2 Delay: 181.0ps

  - Stage 3 Delay: 84.3ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 7.806971e-05W

  - Maximum Power at 100°C: 7.616271e-05W

  - Average Power at 27°C: 4.808150e-06W

  - Average Power at 100°C: 4.392914e-06W

  - Power Temperature Coefficient: -2.612333e-08W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 5.44fF to 9.54fF
...
- [<span style='color: green'>✓</span>] Flicker noise analysis completed
  - Coefficient (K): 5.09e-03
  - Exponent (γ): 3.00e-01 (ideally -1.0 for pure 1/f noise)
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 5.79e-04 V²/Hz
  - Standard Deviation: 8.17e-04 V²/Hz
  - Variation Coefficient: 1.4104
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.9975703310591069
...
- Model: `sky130__fd__pr__rf__nfet__01v8__lvt__bm02__model__expansion_translation`
- Model MD5: `ea67184715039a877bc12b7084c1b293`
- Simulator: `spectre`
- Modes: `dc, transient, ac, noise`
- Started: `2026-07-28T14:27:32.009141+00:00`
- Finished: `2026-07-28T14:29:30.802413+00:00`
- Elapsed seconds: `118.79329`
- Peak resident memory KiB: `225304`
