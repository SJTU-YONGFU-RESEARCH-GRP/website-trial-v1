...
Generated on: 2026-07-28 23:11:39
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/ea67184715039a877bc12b7084c1b293/ngspice/netlist/dc.cir
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/ea67184715039a877bc12b7084c1b293/ngspice/netlist/transient.cir
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/ea67184715039a877bc12b7084c1b293/ngspice/netlist/ac.cir
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/ea67184715039a877bc12b7084c1b293/ngspice/netlist/noise.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -9.67e-04A to 1.30e-19A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -8.46e-04A to 1.41e-19A, IG: -1.04e-17A to 8.67e-19A, IS: -1.41e-19A to 8.46e-04A, IB: -2.04e-31A to 6.04e-11A, KCL Error: 0.00%, Power: 0.00e+00W to 1.02e-03W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000000 /°C, IDS: -9.666e-04A to 1.295e-19A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 1.160e-03W, Efficiency: 3.546e+00 to 1.095e+12, TC: 1.89e-02/°C |
...
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.979 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 4.796e-06A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 70.0ps, Power: 7.586e-05W (max), 5.278e-07W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 339.9ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -6.922405e-08W/°C |
...
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 1.34e-05 V²/Hz, Variation: 2.2876 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -8.46e-04A to 1.41e-19A
  - IG: -1.04e-17A to 8.67e-19A
  - IS: -1.41e-19A to 8.46e-04A
  - IB: -2.04e-31A to 6.04e-11A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -9.666e-04A to 1.295e-19A
...
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 3.546e+00 to 1.095e+12
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: 1.89e-02/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 4.796397e-06A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  ...
  - Maximum Switching Power: 7.586296e-05W

  - Average Switching Power: 5.278167e-07W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 115.2ps

  - Stage 2 Delay: 155.6ps

  - Stage 3 Delay: 69.0ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 7.586296e-05W

  - Maximum Power at 100°C: 7.080961e-05W

  - Average Power at 27°C: 5.278167e-07W

  - Average Power at 100°C: 5.086008e-07W

  - Power Temperature Coefficient: -6.922405e-08W/°C
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 5.765308 fF/µm²
    - Cgs_ls/Area: -1.391382 fF/µm²
    - Cgd_ls/Area: -2.799066 fF/µm²
    - Cgb_ls/Area: -1.574861 fF/µm²
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 1.34e-05 V²/Hz
  - Standard Deviation: 3.07e-05 V²/Hz
  - Variation Coefficient: 2.2876
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.9989296819427834
...
- Started: `2026-07-28T14:27:22.345038+00:00`
- Finished: `2026-07-28T15:12:20.848462+00:00`
- Elapsed seconds: `2698.503438`
- Peak resident memory KiB: `233572`
