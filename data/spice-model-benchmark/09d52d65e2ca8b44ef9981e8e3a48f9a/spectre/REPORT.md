...
Generated on: 2026-07-30 01:02:53
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/09d52d65e2ca8b44ef9981e8e3a48f9a/spectre/netlist/dc.scs
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/09d52d65e2ca8b44ef9981e8e3a48f9a/spectre/netlist/transient.scs
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/09d52d65e2ca8b44ef9981e8e3a48f9a/spectre/netlist/ac.scs
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/09d52d65e2ca8b44ef9981e8e3a48f9a/spectre/netlist/noise.scs
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 26.18fF to 64.08fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0.00650208dB to 0dB, S21 range: -24.7509dB to -24.5377dB |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 3.826e-05A, Rise Time: 400ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 155.578ps (sample interval 4.16639ps), Power: 7.932e-05W (max), 3.893e-06W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 1355.32ps (sample interval 4.16639ps) |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -2.487865e-08W/°C |
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 3.826343e-05A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 155.578ps
  - Transient sample interval: 4.16639ps

  - Maximum Switching Power: 7.931665e-05W

  - Average Switching Power: 3.893051e-06W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 305.132ps

  - Stage 2 Delay: 648.594ps

  - Stage 3 Delay: 370.52ps

  - Total Delay: 1355.32ps
  - Transient sample interval: 4.16639ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 7.931665e-05W

  - Maximum Power at 100°C: 7.750051e-05W

  - Average Power at 27°C: 3.893051e-06W

  - Average Power at 100°C: 3.989147e-06W

  - Power Temperature Coefficient: -2.487865e-08W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 26.18fF to 64.08fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 4.380083 fF/µm²
    - Cgs_ls/Area: -1.360352 fF/µm²
    - Cgd_ls/Area: -0.988429 fF/µm²
...
- [<span style='color: green'>✓</span>] S-parameter analysis verified
  - S11 range: -0.00650208dB to 0dB
  - S21 range: -24.7509dB to -24.5377dB
  - S12 range: -116.151dB to -56.1577dB
  - S22 range: -0.00324652dB to -0.00299976dB
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.9993236106973565
...
- Model: `sky130__fd__pr__nfet__01v8__model__original`
- Model MD5: `09d52d65e2ca8b44ef9981e8e3a48f9a`
- Simulator: `spectre`
- Modes: `dc, transient, ac, noise`
- Started: `2026-07-29T16:59:04.697932+00:00`
- Finished: `2026-07-29T17:03:12.128305+00:00`
- Elapsed seconds: `247.430368`
- Peak resident memory KiB: `380164`
