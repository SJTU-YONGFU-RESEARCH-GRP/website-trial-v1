...
Generated on: 2026-07-27 10:28:06
...
- [<span style='color: green'>✓</span>] Circuit file exists and is readable
  - Path: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/8fe2cab35001be52c78120bad63edea4/ngspice/_ngspice_netlists/dc_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/8fe2cab35001be52c78120bad63edea4/ngspice/_ngspice_netlists/transient_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/8fe2cab35001be52c78120bad63edea4/ngspice/_ngspice_netlists/noise_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/8fe2cab35001be52c78120bad63edea4/ngspice/_ngspice_netlists/ac_circuit.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: -1.20V to 0.00V, VGS: -1.20V to 0.00V, IDS: 0.00e+00A to 3.68e-04A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: 0.00e+00A to 2.67e-04A, IG: 0.00e+00A to 0.00e+00A, IS: -2.67e-04A to 0.00e+00A, IB: -1.20e-15A to 0.00e+00A, KCL Error: 0.00%, Power: 0.00e+00W to 3.21e-04W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: -0.000000 /°C, IDS: 0.000e+00A to 3.682e-04A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 4.418e-04W, Efficiency: 1.784e+00 to 3.909e+10, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 39.17fF to 179.79fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -29dB to -26dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.385 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 4.118e-04A, Rise Time: 0.0ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 159.9ps, Power: 2.591e-05W (max), 1.118e-06W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 212.3ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -4.151499e-08W/°C |
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: 0.000e+00A to 3.682e-04A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 4.418e-04W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 1.784e+00 to 3.909e+10
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 4.117765e-04A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 159.9ps

  - Maximum Switching Power: 2.591401e-05W

  - Average Switching Power: 1.117803e-06W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 159.9ps

  - Stage 2 Delay: 31.6ps

  - Stage 3 Delay: 20.9ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 2.591401e-05W

  - Maximum Power at 100°C: 2.288342e-05W

  - Average Power at 27°C: 1.117803e-06W

  - Average Power at 100°C: 1.117425e-06W

  - Power Temperature Coefficient: -4.151499e-08W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 39.17fF to 179.79fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 8.840805 fF/µm²
    - Cgs_ls/Area: -2.505511 fF/µm²
    - Cgd_ls/Area: -1.770782 fF/µm²
    - Cgb_ls/Area: -4.564527 fF/µm²
...
- Started: `2026-07-27T02:27:21.155825+00:00`
- Finished: `2026-07-27T02:28:06.395108+00:00`
- Elapsed seconds: `45.239274`
- Peak resident memory KiB: `198852`
