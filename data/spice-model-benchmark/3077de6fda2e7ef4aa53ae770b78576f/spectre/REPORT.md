...
Generated on: 2026-07-28 22:39:33
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/3077de6fda2e7ef4aa53ae770b78576f/spectre/netlist/dc.scs
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/3077de6fda2e7ef4aa53ae770b78576f/spectre/netlist/transient.scs
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/3077de6fda2e7ef4aa53ae770b78576f/spectre/netlist/ac.scs
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/3077de6fda2e7ef4aa53ae770b78576f/spectre/netlist/noise.scs
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -9.31e-04A to 3.37e-18A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -8.07e-04A to 0.00e+00A, IG: -1.60e-27A to 3.97e-24A, IS: 0.00e+00A to 8.07e-04A, IB: 0.00e+00A to 5.46e-11A, KCL Error: 0.00%, Power: 0.00e+00W to 9.68e-04W, Temp: -40.0°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000000 /°C, IDS: -9.305e-04A to 3.369e-18A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 1.117e-03W, Efficiency: 3.604e+00 to 8.187e+11, TC: nan/°C |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 4.773e-06A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 74.3ps, Power: 7.803e-05W (max), 4.662e-06W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 376.6ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -2.608297e-08W/°C |
...
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 6.17e-04 V²/Hz, Variation: 1.4124 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -8.07e-04A to 0.00e+00A
  - IG: -1.60e-27A to 3.97e-24A
  - IS: 0.00e+00A to 8.07e-04A
  - IB: 0.00e+00A to 5.46e-11A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -9.305e-04A to 3.369e-18A
...
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 3.604e+00 to 8.187e+11
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 4.772877e-06A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 74.3ps

  - Maximum Switching Power: 7.802850e-05W

  - Average Switching Power: 4.662460e-06W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 115.6ps

  - Stage 2 Delay: 177.3ps

  - Stage 3 Delay: 83.8ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 7.802850e-05W

  - Maximum Power at 100°C: 7.612444e-05W

  - Average Power at 27°C: 4.662460e-06W

  - Average Power at 100°C: 4.343638e-06W

  - Power Temperature Coefficient: -2.608297e-08W/°C
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 6.17e-04 V²/Hz
  - Standard Deviation: 8.71e-04 V²/Hz
  - Variation Coefficient: 1.4124
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.997570331027416
...
- Model: `sky130__fd__pr__rf__nfet__01v8__lvt__bm04__model__original`
- Model MD5: `3077de6fda2e7ef4aa53ae770b78576f`
- Simulator: `spectre`
- Modes: `dc, transient, ac, noise`
- Started: `2026-07-28T14:38:22.545073+00:00`
- Finished: `2026-07-28T14:40:06.202249+00:00`
- Elapsed seconds: `103.657189`
- Peak resident memory KiB: `222136`
