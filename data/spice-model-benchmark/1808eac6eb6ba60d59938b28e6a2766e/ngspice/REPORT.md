...
Generated on: 2026-07-29 00:08:57
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/1808eac6eb6ba60d59938b28e6a2766e/ngspice/netlist/dc.cir
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/1808eac6eb6ba60d59938b28e6a2766e/ngspice/netlist/transient.cir
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/1808eac6eb6ba60d59938b28e6a2766e/ngspice/netlist/ac.cir
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/1808eac6eb6ba60d59938b28e6a2766e/ngspice/netlist/noise.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -1.33e-05A to 2.77e-22A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -1.23e-05A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 1.23e-05A, IB: 0.00e+00A to 1.12e-14A, KCL Error: 0.00%, Power: 0.00e+00W to 1.48e-05W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: -0.000000 /°C, IDS: -1.327e-05A to 2.766e-22A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 1.592e-05W, Efficiency: 9.722e+00 to 4.142e+03, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 0.21fF to 0.33fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: 0dB to 0dB, S21 range: -80dB to -79dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.696 |
...
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 272.2ps, Power: 2.757e-05W (max), 9.202e-08W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 443.7ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -3.002394e-08W/°C |
...
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 1.32e-08 V²/Hz, Variation: 0.0000 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -1.23e-05A to 0.00e+00A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: 0.00e+00A to 1.23e-05A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -1.327e-05A to 2.766e-22A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 1.592e-05W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 9.722e+00 to 4.142e+03
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  ...
  - Maximum Switching Power: 2.757103e-05W

  - Average Switching Power: 9.202384e-08W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 282.2ps

  - Stage 2 Delay: 80.0ps

  - Stage 3 Delay: 81.5ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 2.757103e-05W

  - Maximum Power at 100°C: 2.537928e-05W

  - Average Power at 27°C: 9.202384e-08W

  - Average Power at 100°C: 9.053212e-08W

  - Power Temperature Coefficient: -3.002394e-08W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 0.21fF to 0.33fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 9.103317 fF/µm²
    - Cgs_ls/Area: -3.383661 fF/µm²
    - Cgd_ls/Area: -3.308398 fF/µm²
    - Cgb_ls/Area: -2.411260 fF/µm²
...
- [<span style='color: green'>✓</span>] Flicker noise analysis completed
  ...
  - Exponent (γ): -2.25e-16 (ideally -1.0 for pure 1/f noise)
  - Correlation (R²): 0.1000
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Standard Deviation: 7.38e-25 V²/Hz
...
- Model: `sky130__fd__pr__special__nfet__latch__model__reduction`
- Model MD5: `1808eac6eb6ba60d59938b28e6a2766e`
- Simulator: `ngspice`
- Modes: `dc, transient, ac, noise`
- Started: `2026-07-28T15:27:28.099601+00:00`
- Finished: `2026-07-28T16:09:37.056464+00:00`
- Elapsed seconds: `2528.956877`
- Peak resident memory KiB: `223024`
