...
Generated on: 2026-07-28 20:59:26
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/884d4527aa9a7b801ecb54f761ec440d/hspice/netlist/dc.sp
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/884d4527aa9a7b801ecb54f761ec440d/hspice/netlist/transient.sp
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/884d4527aa9a7b801ecb54f761ec440d/hspice/netlist/ac.sp
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/884d4527aa9a7b801ecb54f761ec440d/hspice/netlist/noise.sp
...
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -1.07e-03A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 1.07e-03A, IB: 0.00e+00A to 1.20e-12A, KCL Error: 0.00%, Power: 0.00e+00W to 1.29e-03W, Temp: -40.0°C |
...
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 1.647e-03W, Efficiency: 6.204e-03 to 2.289e+06, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 214.62fF to 427.30fF |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 2.814e-04A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 240.0ps, Power: 9.097e-05W (max), 9.932e-06W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 4300.0ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: 2.850986e-07W/°C |
...
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 3.92e-07 V²/Hz, Variation: 1.7469 |
...
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 6.204e-03 to 2.289e+06
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 2.813947e-04A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  ...
  - Maximum Switching Power: 9.096876e-05W

  - Average Switching Power: 9.931707e-06W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 710.0ps

  - Stage 2 Delay: 6880.0ps

  - Stage 3 Delay: 11170.0ps

  - Total Delay: 4300.0ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 9.096876e-05W

  - Maximum Power at 100°C: 1.117810e-04W

  - Average Power at 27°C: 9.931707e-06W

  - Average Power at 100°C: 1.381638e-05W

  - Power Temperature Coefficient: 2.850986e-07W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 214.62fF to 427.30fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Cgg_ls: 304.092379 fF
  - Cgs_ls: -136.961861 fF
  - Cgd_ls: -101.550476 fF
  - Cgb_ls: -65.581296 fF
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 3.92e-07 V²/Hz
  - Standard Deviation: 6.84e-07 V²/Hz
  - Variation Coefficient: 1.7469
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.99893070187931
...
- Started: `2026-07-28T12:57:27.187186+00:00`
- Finished: `2026-07-28T13:00:04.692399+00:00`
- Elapsed seconds: `157.505224`
- Peak resident memory KiB: `290752`
