...
Generated on: 2026-07-28 21:42:03
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/884d4527aa9a7b801ecb54f761ec440d/ngspice/netlist/dc.cir
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/884d4527aa9a7b801ecb54f761ec440d/ngspice/netlist/transient.cir
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/884d4527aa9a7b801ecb54f761ec440d/ngspice/netlist/ac.cir
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/884d4527aa9a7b801ecb54f761ec440d/ngspice/netlist/noise.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -1.37e-03A to 0.00e+00A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -1.07e-03A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 1.07e-03A, IB: 0.00e+00A to 1.20e-15A, KCL Error: 0.00%, Power: 0.00e+00W to 1.28e-03W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000001 /°C, IDS: -1.372e-03A to 0.000e+00A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 1.647e-03W, Efficiency: 3.685e-03 to 2.289e+06, TC: nan/°C |

### AC Analysis Summary
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 214.61fF to 427.30fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -20dB to -17dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.5 |
...
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 2.781e-04A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 240.0ps, Power: 7.752e-05W (max), 9.937e-06W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 4273.0ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: 2.101871e-08W/°C |
...
| [Flicker (1/f) Noise](#flicker-noise-analysis) | <span style='color: green'>✓</span> | Exponent: 0.4996, Corner Freq: not resolved |
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 1.18e-06 V²/Hz, Variation: 2.0209 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -1.07e-03A to 0.00e+00A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: 0.00e+00A to 1.07e-03A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -1.372e-03A to 0.000e+00A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 1.647e-03W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 3.685e-03 to 2.289e+06
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 2.781354e-04A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  ...
  - Maximum Switching Power: 7.752364e-05W

  - Average Switching Power: 9.936790e-06W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 710.2ps

  - Stage 2 Delay: 6862.8ps

  - Stage 3 Delay: 11178.6ps

  - Total Delay: 4273.0ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 7.752364e-05W

  - Maximum Power at 100°C: 7.905801e-05W

  - Average Power at 27°C: 9.936790e-06W

  - Average Power at 100°C: 1.349602e-05W

  - Power Temperature Coefficient: 2.101871e-08W/°C
...
<img src='plots/trans_quasi_static_time.png' alt='Quasi-Static Analysis' width='400'/>
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 214.61fF to 427.30fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Cgg_ls: 304.093512 fF
  - Cgs_ls: -136.956429 fF
  - Cgd_ls: -101.555711 fF
  - Cgb_ls: -65.581451 fF
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 2.174802 fF/µm²
    - Cgs_ls/Area: -0.979479 fF/µm²
    - Cgd_ls/Area: -0.726301 fF/µm²
    - Cgb_ls/Area: -0.469022 fF/µm²
...
- [<span style='color: green'>✓</span>] S-parameter analysis verified
  ...
  - S21 range: -20dB to -17dB
  - S12 range: -95dB to -35dB
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 1.18e-06 V²/Hz
  - Standard Deviation: 2.38e-06 V²/Hz
  - Variation Coefficient: 2.0209
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.9989296819398783
