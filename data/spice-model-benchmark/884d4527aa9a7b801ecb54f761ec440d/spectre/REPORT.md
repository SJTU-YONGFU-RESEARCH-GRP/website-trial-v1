...
Generated on: 2026-07-28 20:58:43
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/884d4527aa9a7b801ecb54f761ec440d/spectre/netlist/dc.scs
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/884d4527aa9a7b801ecb54f761ec440d/spectre/netlist/transient.scs
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/884d4527aa9a7b801ecb54f761ec440d/spectre/netlist/ac.scs
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/884d4527aa9a7b801ecb54f761ec440d/spectre/netlist/noise.scs
...
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -1.07e-03A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 1.07e-03A, IB: 0.00e+00A to 1.20e-12A, KCL Error: 0.00%, Power: 0.00e+00W to 1.28e-03W, Temp: -40.0°C |
...
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 1.647e-03W, Efficiency: 3.679e-03 to 2.289e+06, TC: nan/°C |
...
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.50° |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 2.839e-04A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 238.9ps, Power: 7.951e-05W (max), 1.213e-05W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 4252.1ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -2.353417e-08W/°C |
...
| [Flicker (1/f) Noise](#flicker-noise-analysis) | <span style='color: green'>✓</span> | Exponent: 0.2499, Corner Freq: not resolved |
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 1.99e-04 V²/Hz, Variation: 1.2018 |
...
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 3.679e-03 to 2.289e+06
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 2.839350e-04A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 238.9ps

  - Maximum Switching Power: 7.951380e-05W

  - Average Switching Power: 1.212907e-05W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 715.4ps

  - Stage 2 Delay: 6745.1ps

  - Stage 3 Delay: 11319.0ps

  - Total Delay: 4252.1ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 7.951380e-05W

  - Maximum Power at 100°C: 7.779581e-05W

  - Average Power at 27°C: 1.212907e-05W

  - Average Power at 100°C: 1.030389e-05W

  - Power Temperature Coefficient: -2.353417e-08W/°C
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Cgg_ls: 304.093506 fF
  - Cgs_ls: -136.956443 fF
  - Cgd_ls: -101.555648 fF
  - Cgb_ls: -65.581417 fF
...
- [<span style='color: green'>✓</span>] Flicker noise analysis completed
  - Coefficient (K): 1.24e-03
  - Exponent (γ): 2.50e-01 (ideally -1.0 for pure 1/f noise)
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 1.99e-04 V²/Hz
  - Standard Deviation: 2.39e-04 V²/Hz
  - Variation Coefficient: 1.2018
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.9975703592212455
...
- Model: `sky130__fd__pr__nfet__20v0__zvt__base__reduction`
- Model MD5: `884d4527aa9a7b801ecb54f761ec440d`
- Simulator: `spectre`
- Modes: `dc, transient, ac, noise`
- Started: `2026-07-28T12:56:56.960049+00:00`
- Finished: `2026-07-28T12:59:18.737221+00:00`
- Elapsed seconds: `141.777167`
- Peak resident memory KiB: `224228`
