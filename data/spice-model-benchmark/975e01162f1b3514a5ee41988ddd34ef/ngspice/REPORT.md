...
Generated on: 2026-07-27 06:15:13
...
- [<span style='color: green'>✓</span>] Circuit file exists and is readable
  - Path: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/975e01162f1b3514a5ee41988ddd34ef/ngspice/_ngspice_netlists/dc_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/975e01162f1b3514a5ee41988ddd34ef/ngspice/_ngspice_netlists/transient_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/975e01162f1b3514a5ee41988ddd34ef/ngspice/_ngspice_netlists/noise_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/975e01162f1b3514a5ee41988ddd34ef/ngspice/_ngspice_netlists/ac_circuit.cir
...
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -7.77e-04A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 7.77e-04A, IB: 0.00e+00A to 1.20e-15A, KCL Error: 0.00%, Power: 0.00e+00W to 9.32e-04W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000001 /°C, IDS: -1.055e-03A to 0.000e+00A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 1.266e-03W, Efficiency: 2.770e+00 to 6.228e+10, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 23.24fF to 84.44fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -20dB to -19dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.905 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 4.490e-05A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 328.3ps, Power: 1.319e-03W (max), 7.052e-05W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 2437.3ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -1.593450e-06W/°C |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -7.77e-04A to 0.00e+00A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: 0.00e+00A to 7.77e-04A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -1.055e-03A to 0.000e+00A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 1.266e-03W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 2.770e+00 to 6.228e+10
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 4.489619e-05A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 328.3ps

  - Maximum Switching Power: 1.318912e-03W

  - Average Switching Power: 7.052154e-05W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 527.6ps

  - Stage 2 Delay: 1315.3ps

  - Stage 3 Delay: 594.4ps

  - Total Delay: 2437.3ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 1.318912e-03W

  - Maximum Power at 100°C: 1.202590e-03W

  - Average Power at 27°C: 7.052154e-05W

  - Average Power at 100°C: 6.092022e-05W

  - Power Temperature Coefficient: -1.593450e-06W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 23.24fF to 84.44fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 4.944265 fF/µm²
    - Cgs_ls/Area: -1.155397 fF/µm²
    - Cgd_ls/Area: -0.809082 fF/µm²
    - Cgb_ls/Area: -2.979782 fF/µm²
...
- Started: `2026-07-26T22:13:43.886804+00:00`
- Finished: `2026-07-26T22:15:14.098124+00:00`
- Elapsed seconds: `90.211325`
- Peak resident memory KiB: `207072`
