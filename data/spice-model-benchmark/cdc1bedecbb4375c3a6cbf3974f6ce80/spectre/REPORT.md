...
Generated on: 2026-07-28 21:13:28
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/cdc1bedecbb4375c3a6cbf3974f6ce80/spectre/netlist/dc.scs
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/cdc1bedecbb4375c3a6cbf3974f6ce80/spectre/netlist/transient.scs
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/cdc1bedecbb4375c3a6cbf3974f6ce80/spectre/netlist/ac.scs
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/cdc1bedecbb4375c3a6cbf3974f6ce80/spectre/netlist/noise.scs
...
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -3.08e-05A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 3.08e-05A, IB: 0.00e+00A to 1.20e-12A, KCL Error: 0.00%, Power: 0.00e+00W to 3.70e-05W, Temp: -40.0°C |
...
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 5.086e-05W, Efficiency: 3.779e+00 to 4.171e+03, TC: nan/°C |
...
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 178.24° |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 5.823e-06A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 355.8ps, Power: 7.815e-05W (max), 3.525e-06W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 1384.9ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -2.701506e-08W/°C |
...
| [Flicker (1/f) Noise](#flicker-noise-analysis) | <span style='color: green'>✓</span> | Exponent: 0.0648, Corner Freq: not resolved |
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 3.89e-04 V²/Hz, Variation: 1.0979 |
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 5.086e-05W
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 5.822656e-06A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 355.8ps

  - Maximum Switching Power: 7.815443e-05W

  - Average Switching Power: 3.525012e-06W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 602.8ps

  - Stage 2 Delay: 415.9ps

  - Stage 3 Delay: 366.3ps

  - Total Delay: 1384.9ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 7.815443e-05W

  - Maximum Power at 100°C: 7.618233e-05W

  - Average Power at 27°C: 3.525012e-06W

  - Average Power at 100°C: 3.308284e-06W

  - Power Temperature Coefficient: -2.701506e-08W/°C
...
- [<span style='color: green'>✓</span>] Flicker noise analysis completed
  - Coefficient (K): 1.60e-04
  - Exponent (γ): 6.48e-02 (ideally -1.0 for pure 1/f noise)
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 3.89e-04 V²/Hz
  - Standard Deviation: 4.27e-04 V²/Hz
  - Variation Coefficient: 1.0979
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.9975703589587854
...
- Started: `2026-07-28T13:12:05.963548+00:00`
- Finished: `2026-07-28T13:14:04.330315+00:00`
- Elapsed seconds: `118.366784`
- Peak resident memory KiB: `246988`
