...
Generated on: 2026-07-28 20:56:17
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/3d6238f92babe26000f6e20791eb7081/hspice/netlist/dc.sp
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/3d6238f92babe26000f6e20791eb7081/hspice/netlist/transient.sp
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/3d6238f92babe26000f6e20791eb7081/hspice/netlist/ac.sp
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/3d6238f92babe26000f6e20791eb7081/hspice/netlist/noise.sp
...
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -3.26e-05A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 3.26e-05A, IB: 0.00e+00A to 1.20e-12A, KCL Error: 0.00%, Power: 0.00e+00W to 3.91e-05W, Temp: -40.0°C |
...
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 4.416e-05W, Efficiency: 3.333e-01 to 4.159e+03, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 213.68fF to 463.95fF |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 2.508e-04A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 970.0ps, Power: 9.139e-05W (max), 2.156e-06W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 310.0ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: 2.850888e-07W/°C |
...
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 1.94e-08 V²/Hz, Variation: 0.7291 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -3.26e-05A to 0.00e+00A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: 0.00e+00A to 3.26e-05A
...
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 3.333e-01 to 4.159e+03
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 2.508450e-04A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 970.0ps

  - Maximum Switching Power: 9.139452e-05W

  - Average Switching Power: 2.155796e-06W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 6730.0ps

  - Stage 2 Delay: 7230.0ps

  - Stage 3 Delay: 6150.0ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 9.139452e-05W

  - Maximum Power at 100°C: 1.122060e-04W

  - Average Power at 27°C: 2.155796e-06W

  - Average Power at 100°C: 2.194008e-06W

  - Power Temperature Coefficient: 2.850888e-07W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 213.68fF to 463.95fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Cgg_ls: 283.277893 fF
  - Cgs_ls: -32.359002 fF
  - Cgd_ls: -26.185505 fF
  - Cgb_ls: -224.734618 fF
...
- [<span style='color: green'>✓</span>] Flicker noise analysis completed
  ...
  - Exponent (γ): 2.02e-08 (ideally -1.0 for pure 1/f noise)
  - Correlation (R²): 0.3467
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 1.94e-08 V²/Hz
  - Standard Deviation: 1.42e-08 V²/Hz
  - Variation Coefficient: 0.7291
...
- Started: `2026-07-28T12:54:15.571866+00:00`
- Finished: `2026-07-28T12:56:56.849618+00:00`
- Elapsed seconds: `161.277773`
- Peak resident memory KiB: `288868`
