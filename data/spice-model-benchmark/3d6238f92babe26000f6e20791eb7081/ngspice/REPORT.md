...
Generated on: 2026-07-28 21:37:40
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/3d6238f92babe26000f6e20791eb7081/ngspice/netlist/dc.cir
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/3d6238f92babe26000f6e20791eb7081/ngspice/netlist/transient.cir
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/3d6238f92babe26000f6e20791eb7081/ngspice/netlist/ac.cir
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/3d6238f92babe26000f6e20791eb7081/ngspice/netlist/noise.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -3.68e-05A to 0.00e+00A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -3.27e-05A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 3.27e-05A, IB: 0.00e+00A to 1.20e-15A, KCL Error: 0.00%, Power: 0.00e+00W to 3.93e-05W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: -0.000000 /°C, IDS: -3.680e-05A to 0.000e+00A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 4.416e-05W, Efficiency: 3.363e-01 to 4.159e+03, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 213.69fF to 463.95fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -95dB to -36dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 92.4989 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 2.472e-04A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 963.3ps, Power: 7.794e-05W (max), 2.067e-06W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 315.9ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: 2.007301e-08W/°C |
...
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 1.38e-08 V²/Hz, Variation: 0.1910 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -3.27e-05A to 0.00e+00A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: 0.00e+00A to 3.27e-05A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -3.680e-05A to 0.000e+00A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 4.416e-05W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 3.363e-01 to 4.159e+03
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 2.472404e-04A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 963.3ps

  - Maximum Switching Power: 7.794439e-05W

  - Average Switching Power: 2.067110e-06W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 6743.3ps

  - Stage 2 Delay: 7540.5ps

  - Stage 3 Delay: 860.0ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 7.794439e-05W

  - Maximum Power at 100°C: 7.940972e-05W

  - Average Power at 27°C: 2.067110e-06W

  - Average Power at 100°C: 2.071482e-06W

  - Power Temperature Coefficient: 2.007301e-08W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 213.69fF to 463.95fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Cgg_ls: 283.278688 fF
  - Cgs_ls: -32.359116 fF
  - Cgd_ls: -26.185539 fF
  - Cgb_ls: -224.734089 fF
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 2.025939 fF/µm²
    - Cgs_ls/Area: -0.231424 fF/µm²
    - Cgd_ls/Area: -0.187273 fF/µm²
    - Cgb_ls/Area: -1.607243 fF/µm²
...
- [<span style='color: green'>✓</span>] S-parameter analysis verified
  ...
  - S21 range: -95dB to -36dB
  - S12 range: -101dB to -41dB
...
- [<span style='color: green'>✓</span>] Flicker noise analysis completed
  ...
  - Exponent (γ): 1.72e-10 (ideally -1.0 for pure 1/f noise)
  - Correlation (R²): 0.4683
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Standard Deviation: 2.64e-09 V²/Hz
  - Variation Coefficient: 0.1910
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.9989296819398983
...
- Model: `sky130__fd__pr__nfet__20v0__zvt__base__fitting_reduction_translation`
- Model MD5: `3d6238f92babe26000f6e20791eb7081`
- Simulator: `ngspice`
- Modes: `dc, transient, ac, noise`
- Started: `2026-07-28T12:52:21.653564+00:00`
- Finished: `2026-07-28T13:38:22.478283+00:00`
- Elapsed seconds: `2760.824724`
- Peak resident memory KiB: `234540`
