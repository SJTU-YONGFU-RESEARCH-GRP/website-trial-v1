...
Generated on: 2026-07-28 23:49:29
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/39ecf2e4bbbbdb80eb4936a07629029b/ngspice/netlist/dc.cir
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/39ecf2e4bbbbdb80eb4936a07629029b/ngspice/netlist/transient.cir
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/39ecf2e4bbbbdb80eb4936a07629029b/ngspice/netlist/ac.cir
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/39ecf2e4bbbbdb80eb4936a07629029b/ngspice/netlist/noise.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: -1.20V to 0.00V, VGS: -1.20V to 0.00V, IDS: -1.37e-25A to 1.31e-04A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -1.60e-32A to 7.49e-05A, IG: 0.00e+00A to 1.73e-18A, IS: -7.49e-05A to 1.47e-34A, IB: -2.13e-12A to 3.21e-32A, KCL Error: 0.00%, Power: 0.00e+00W to 8.99e-05W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000000 /°C, IDS: -1.370e-25A to 1.311e-04A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 1.573e-04W, Efficiency: 5.808e+00 to 8.929e+10, TC: 3.32e-02/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 5.47fF to 8.87fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -52dB to -51dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.677 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 7.970e-05A, Rise Time: 0.0ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 250.0ps, Power: 6.281e-05W (max), 5.117e-07W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 759.7ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: 6.941372e-08W/°C |
...
| [Flicker (1/f) Noise](#flicker-noise-analysis) | <span style='color: green'>✓</span> | Exponent: 0.4243, Corner Freq: not resolved |
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 6.36e-07 V²/Hz, Variation: 2.0262 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -1.60e-32A to 7.49e-05A
  - IG: 0.00e+00A to 1.73e-18A
  - IS: -7.49e-05A to 1.47e-34A
  - IB: -2.13e-12A to 3.21e-32A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -1.370e-25A to 1.311e-04A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 1.573e-04W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 5.808e+00 to 8.929e+10
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: 3.32e-02/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 7.970143e-05A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 250.0ps

  - Maximum Switching Power: 6.281242e-05W

  - Average Switching Power: 5.117136e-07W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 298.3ps

  - Stage 2 Delay: 280.0ps

  - Stage 3 Delay: 181.4ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 6.281242e-05W

  - Maximum Power at 100°C: 6.787962e-05W

  - Average Power at 27°C: 5.117136e-07W

  - Average Power at 100°C: 5.135664e-07W

  - Power Temperature Coefficient: 6.941372e-08W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 5.47fF to 8.87fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 5.171618 fF/µm²
    - Cgs_ls/Area: -0.918300 fF/µm²
    - Cgd_ls/Area: -1.334121 fF/µm²
    - Cgb_ls/Area: -2.919198 fF/µm²
...
- [<span style='color: green'>✓</span>] S-parameter analysis verified
  ...
  - S21 range: -52dB to -51dB
  - S12 range: -121dB to -61dB
...
- [<span style='color: green'>✓</span>] Flicker noise analysis completed
  - Coefficient (K): 2.41e+03
  - Exponent (γ): 4.24e-01 (ideally -1.0 for pure 1/f noise)
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 6.36e-07 V²/Hz
  - Standard Deviation: 1.29e-06 V²/Hz
  - Variation Coefficient: 2.0262
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.9989296819401882
...
- Model: `sky130__fd__pr__rf__pfet__01v8__bm02__model__expansion_translation`
- Model MD5: `39ecf2e4bbbbdb80eb4936a07629029b`
- Simulator: `ngspice`
- Modes: `dc, transient, ac, noise`
- Started: `2026-07-28T15:07:40.964833+00:00`
- Finished: `2026-07-28T15:50:25.085521+00:00`
- Elapsed seconds: `2564.120704`
- Peak resident memory KiB: `223112`
