...
Generated on: 2026-07-28 22:23:45
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/daab22d851f57fbc99dba5f57e4c0a53/ngspice/netlist/dc.cir
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/daab22d851f57fbc99dba5f57e4c0a53/ngspice/netlist/transient.cir
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/daab22d851f57fbc99dba5f57e4c0a53/ngspice/netlist/ac.cir
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/daab22d851f57fbc99dba5f57e4c0a53/ngspice/netlist/noise.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: -1.20V to 0.00V, VGS: -1.20V to 0.00V, IDS: 0.00e+00A to 1.41e-04A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: 0.00e+00A to 1.38e-04A, IG: 0.00e+00A to 0.00e+00A, IS: -1.38e-04A to 0.00e+00A, IB: -1.20e-15A to 0.00e+00A, KCL Error: 0.00%, Power: 0.00e+00W to 1.66e-04W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000000 /°C, IDS: 0.000e+00A to 1.406e-04A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 1.687e-04W, Efficiency: 1.445e+01 to 5.811e+09, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 0.91fF to 2.12fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -36dB to -36dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.985 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 1.389e-04A, Rise Time: 0.0ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 180.0ps, Power: 1.688e-05W (max), 1.630e-07W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 301.6ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -2.892058e-09W/°C |
...
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 9.69e-05 V²/Hz, Variation: 2.0514 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: 0.00e+00A to 1.38e-04A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: -1.38e-04A to 0.00e+00A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: 0.000e+00A to 1.406e-04A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 1.687e-04W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 1.445e+01 to 5.811e+09
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 1.389182e-04A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 180.0ps

  - Maximum Switching Power: 1.688388e-05W

  - Average Switching Power: 1.629695e-07W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 208.2ps

  - Stage 2 Delay: 50.0ps

  - Stage 3 Delay: 43.4ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 1.688388e-05W

  - Maximum Power at 100°C: 1.667276e-05W

  - Average Power at 27°C: 1.629695e-07W

  - Average Power at 100°C: 2.463129e-07W

  - Power Temperature Coefficient: -2.892058e-09W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 0.91fF to 2.12fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 5.673359 fF/µm²
    - Cgs_ls/Area: -2.025002 fF/µm²
    - Cgd_ls/Area: -1.781857 fF/µm²
    - Cgb_ls/Area: -1.866501 fF/µm²
...
- [<span style='color: green'>✓</span>] S-parameter analysis verified
  ...
  - S21 range: -36dB to -36dB
  - S12 range: -145dB to -85dB
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 9.69e-05 V²/Hz
  - Standard Deviation: 1.99e-04 V²/Hz
  - Variation Coefficient: 2.0514
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.9989296819398124
...
- Model: `sky130__fd__pr__pfet__01v8__mvt__model__fitting_reduction_translation`
- Model MD5: `daab22d851f57fbc99dba5f57e4c0a53`
- Simulator: `ngspice`
- Modes: `dc, transient, ac, noise`
- Started: `2026-07-28T13:42:38.921417+00:00`
- Finished: `2026-07-28T14:24:20.536090+00:00`
- Elapsed seconds: `2501.614695`
- Peak resident memory KiB: `227972`
