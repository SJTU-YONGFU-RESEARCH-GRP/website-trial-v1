...
Generated on: 2026-07-28 23:39:04
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/3c9cb81cdfd968f095621cbf8586d831/ngspice/netlist/dc.cir
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/3c9cb81cdfd968f095621cbf8586d831/ngspice/netlist/transient.cir
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/3c9cb81cdfd968f095621cbf8586d831/ngspice/netlist/ac.cir
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/3c9cb81cdfd968f095621cbf8586d831/ngspice/netlist/noise.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -2.06e-04A to 3.71e-21A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -1.91e-04A to -1.01e-35A, IG: -3.47e-18A to 1.73e-18A, IS: -1.72e-32A to 1.91e-04A, IB: -2.63e-33A to 1.56e-15A, KCL Error: 0.00%, Power: 0.00e+00W to 2.29e-04W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: -0.000000 /°C, IDS: -2.056e-04A to 3.709e-21A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 2.468e-04W, Efficiency: 5.579e+00 to 9.060e+10, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 6.76fF to 9.24fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -39dB to -39dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.873 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 5.759e-06A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 220.0ps, Power: 7.644e-05W (max), 8.683e-07W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 709.8ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: 1.707311e-08W/°C |
...
| [Flicker (1/f) Noise](#flicker-noise-analysis) | <span style='color: green'>✓</span> | Exponent: 0.4392, Corner Freq: not resolved |
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 4.29e-06 V²/Hz, Variation: 1.9040 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -1.91e-04A to -1.01e-35A
  - IG: -3.47e-18A to 1.73e-18A
  - IS: -1.72e-32A to 1.91e-04A
  - IB: -2.63e-33A to 1.56e-15A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -2.056e-04A to 3.709e-21A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 2.468e-04W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 5.579e+00 to 9.060e+10
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 5.759124e-06A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 220.0ps

  - Maximum Switching Power: 7.644127e-05W

  - Average Switching Power: 8.683259e-07W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 257.3ps

  - Stage 2 Delay: 252.5ps

  - Stage 3 Delay: 200.0ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 7.644127e-05W

  - Maximum Power at 100°C: 7.768761e-05W

  - Average Power at 27°C: 8.683259e-07W

  - Average Power at 100°C: 8.571082e-07W

  - Power Temperature Coefficient: 1.707311e-08W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 6.76fF to 9.24fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 2.160010 fF/µm²
    - Cgs_ls/Area: -0.774030 fF/µm²
    - Cgd_ls/Area: -0.745131 fF/µm²
    - Cgb_ls/Area: -0.640850 fF/µm²
...
- [<span style='color: green'>✓</span>] S-parameter analysis verified
  ...
  - S21 range: -39dB to -39dB
  - S12 range: -117dB to -57dB
...
- [<span style='color: green'>✓</span>] Flicker noise analysis completed
  - Coefficient (K): 9.15e+03
  - Exponent (γ): 4.39e-01 (ideally -1.0 for pure 1/f noise)
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 4.29e-06 V²/Hz
  - Standard Deviation: 8.16e-06 V²/Hz
  - Variation Coefficient: 1.9040
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.9989296819400989
...
- Model: `sky130__fd__pr__rf__nfet__g5v0d10v5__bm10__model__expansion_translation`
- Model MD5: `3c9cb81cdfd968f095621cbf8586d831`
- Simulator: `ngspice`
- Modes: `dc, transient, ac, noise`
- Started: `2026-07-28T14:59:33.222342+00:00`
- Finished: `2026-07-28T15:39:38.855639+00:00`
- Elapsed seconds: `2405.633308`
- Peak resident memory KiB: `223816`
