...
Generated on: 2026-07-27 10:19:19
...
- [<span style='color: green'>✓</span>] Circuit file exists and is readable
  - Path: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/80ea231b6043eed3bf298e21004cbe9d/ngspice/_ngspice_netlists/dc_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/80ea231b6043eed3bf298e21004cbe9d/ngspice/_ngspice_netlists/transient_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/80ea231b6043eed3bf298e21004cbe9d/ngspice/_ngspice_netlists/noise_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/80ea231b6043eed3bf298e21004cbe9d/ngspice/_ngspice_netlists/ac_circuit.cir
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 48.74fF to 268.54fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -26dB to -23dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.407 |
...
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 132.4ps, Power: 2.584e-05W (max), 1.086e-06W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 200.9ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -4.002520e-08W/°C |
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 5.855031e-04A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 132.4ps

  - Maximum Switching Power: 2.583844e-05W

  - Average Switching Power: 1.085669e-06W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 132.4ps

  - Stage 2 Delay: 49.2ps

  - Stage 3 Delay: 19.4ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 2.583844e-05W

  - Maximum Power at 100°C: 2.291661e-05W

  - Average Power at 27°C: 1.085669e-06W

  - Average Power at 100°C: 1.151847e-06W

  - Power Temperature Coefficient: -4.002520e-08W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 48.74fF to 268.54fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 14.789650 fF/µm²
    - Cgs_ls/Area: -3.574273 fF/µm²
    - Cgd_ls/Area: -2.458465 fF/µm²
    - Cgb_ls/Area: -8.756910 fF/µm²
...
- Started: `2026-07-27T02:18:24.711111+00:00`
- Finished: `2026-07-27T02:19:19.520267+00:00`
- Elapsed seconds: `54.809161`
- Peak resident memory KiB: `208968`
