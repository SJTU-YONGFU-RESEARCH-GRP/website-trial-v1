...
Generated on: 2026-07-27 04:04:39
...
- [<span style='color: green'>✓</span>] Circuit file exists and is readable
  - Path: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/c3e9f80f713f30271aa7d9ea215f636c/ngspice/_ngspice_netlists/dc_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/c3e9f80f713f30271aa7d9ea215f636c/ngspice/_ngspice_netlists/transient_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/c3e9f80f713f30271aa7d9ea215f636c/ngspice/_ngspice_netlists/noise_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/c3e9f80f713f30271aa7d9ea215f636c/ngspice/_ngspice_netlists/ac_circuit.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -6.77e-04A to 0.00e+00A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -4.90e-04A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 4.90e-04A, IB: 0.00e+00A to 1.20e-15A, KCL Error: 0.00%, Power: 0.00e+00W to 5.88e-04W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000000 /°C, IDS: -6.768e-04A to 0.000e+00A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 8.121e-04W, Efficiency: 2.494e+00 to 1.197e+11, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 29.97fF to 92.13fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -24dB to -23dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.822 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 3.344e-04A, Rise Time: 0.1ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 45.0ps, Power: 6.874e-05W (max), 4.050e-06W (avg) |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -4.90e-04A to 0.00e+00A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: 0.00e+00A to 4.90e-04A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -6.768e-04A to 0.000e+00A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 8.121e-04W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 2.494e+00 to 1.197e+11
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 3.344097e-04A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  ...
  - Maximum Switching Power: 6.874177e-05W

  - Average Switching Power: 4.050194e-06W
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 6.874177e-05W

  - Maximum Power at 100°C: 5.970064e-05W

  - Average Power at 27°C: 4.050194e-06W

  - Average Power at 100°C: 4.014150e-06W
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 29.97fF to 92.13fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 5.438733 fF/µm²
    - Cgs_ls/Area: -1.524226 fF/µm²
    - Cgd_ls/Area: -1.175773 fF/µm²
    - Cgb_ls/Area: -2.738732 fF/µm²
...
- Started: `2026-07-26T19:58:17.938417+00:00`
- Finished: `2026-07-26T20:04:39.872786+00:00`
- Elapsed seconds: `381.934367`
- Peak resident memory KiB: `219952`
