...
Generated on: 2026-07-28 20:51:41
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/22e375496bbf85efad8f6683108a2ccb/spectre/netlist/dc.scs
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/22e375496bbf85efad8f6683108a2ccb/spectre/netlist/transient.scs
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/22e375496bbf85efad8f6683108a2ccb/spectre/netlist/ac.scs
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/22e375496bbf85efad8f6683108a2ccb/spectre/netlist/noise.scs
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -1.05e-03A to 0.00e+00A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -8.11e-04A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 8.11e-04A, IB: 0.00e+00A to 1.20e-12A, KCL Error: 0.00%, Power: 0.00e+00W to 9.73e-04W, Temp: -40.0°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000001 /°C, IDS: -1.051e-03A to 0.000e+00A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 1.261e-03W, Efficiency: 1.629e+00 to 2.659e+06, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 230.18fF to 468.46fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: 1dB to 1dB, S21 range: 0dB to 0dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.00° |
...
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 332.7ps, Power: 7.961e-05W (max), 1.020e-05W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 5227.5ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -2.386106e-08W/°C |
...
| [Flicker (1/f) Noise](#flicker-noise-analysis) | <span style='color: green'>✓</span> | Exponent: 0.2210, Corner Freq: not resolved |
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 1.26e-04 V²/Hz, Variation: 0.8766 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -8.11e-04A to 0.00e+00A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: 0.00e+00A to 8.11e-04A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -1.051e-03A to 0.000e+00A
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 3.100750e-04A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 332.7ps

  - Maximum Switching Power: 7.960535e-05W

  - Average Switching Power: 1.020346e-05W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 981.1ps

  - Stage 2 Delay: 9716.5ps

  - Stage 3 Delay: 10809.3ps

  - Total Delay: 5227.5ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 7.960535e-05W

  - Maximum Power at 100°C: 7.786350e-05W

  - Average Power at 27°C: 1.020346e-05W

  - Average Power at 100°C: 7.599559e-06W

  - Power Temperature Coefficient: -2.386106e-08W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 230.18fF to 468.46fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Cgg_ls: 353.241787 fF
  - Cgs_ls: -181.212426 fF
  - Cgd_ls: -142.777197 fF
  - Cgb_ls: -29.252168 fF
...
- [<span style='color: green'>✓</span>] Flicker noise analysis completed
  - Coefficient (K): 6.71e-04
  - Exponent (γ): 2.21e-01 (ideally -1.0 for pure 1/f noise)
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 1.26e-04 V²/Hz
  - Standard Deviation: 1.11e-04 V²/Hz
  - Variation Coefficient: 0.8766
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.9975702480207127
...
- Started: `2026-07-28T12:50:09.934965+00:00`
- Finished: `2026-07-28T12:52:21.440832+00:00`
- Elapsed seconds: `131.505878`
- Peak resident memory KiB: `244848`
