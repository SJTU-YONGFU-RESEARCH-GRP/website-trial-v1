...
Generated on: 2026-07-28 21:34:56
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/22e375496bbf85efad8f6683108a2ccb/ngspice/netlist/dc.cir
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/22e375496bbf85efad8f6683108a2ccb/ngspice/netlist/transient.cir
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/22e375496bbf85efad8f6683108a2ccb/ngspice/netlist/ac.cir
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/22e375496bbf85efad8f6683108a2ccb/ngspice/netlist/noise.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -1.05e-03A to 7.64e-41A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -8.11e-04A to 3.23e-44A, IG: 0.00e+00A to 0.00e+00A, IS: 1.31e-43A to 8.11e-04A, IB: -1.64e-43A to 2.34e-15A, KCL Error: 0.00%, Power: 0.00e+00W to 9.73e-04W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000001 /°C, IDS: -1.051e-03A to 7.641e-41A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 1.261e-03W, Efficiency: 1.629e+00 to 2.659e+06, TC: 1.05e-04/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 230.19fF to 468.46fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -23dB to -17dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 178.998 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 3.101e-04A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 331.1ps, Power: 7.762e-05W (max), 1.357e-05W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 5212.2ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: 2.073948e-08W/°C |
...
| [Flicker (1/f) Noise](#flicker-noise-analysis) | <span style='color: green'>✓</span> | Exponent: 0.4414, Corner Freq: not resolved |
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 2.61e-07 V²/Hz, Variation: 1.7396 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -8.11e-04A to 3.23e-44A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: 1.31e-43A to 8.11e-04A
  - IB: -1.64e-43A to 2.34e-15A
...
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Temperature Coefficient: 0.000001 /°C
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -1.051e-03A to 7.641e-41A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 1.261e-03W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 1.629e+00 to 2.659e+06
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: 1.05e-04/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 3.101476e-04A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 331.1ps

  - Maximum Switching Power: 7.761516e-05W

  - Average Switching Power: 1.356847e-05W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 982.2ps

  - Stage 2 Delay: 9712.9ps

  - Stage 3 Delay: 10827.1ps

  - Total Delay: 5212.2ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 7.761516e-05W

  - Maximum Power at 100°C: 7.912915e-05W

  - Average Power at 27°C: 1.356847e-05W

  - Average Power at 100°C: 1.653319e-05W

  - Power Temperature Coefficient: 2.073948e-08W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 230.19fF to 468.46fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Cgg_ls: 353.241825 fF
  - Cgs_ls: -181.212474 fF
  - Cgd_ls: -142.777189 fF
  - Cgb_ls: -29.252190 fF
  ...
  - Per-gate-area (W*L) normalization available
    - Geometry: W=29.9975 µm, L=4.66125 µm, Area=139.826 µm²
    - Cgg_ls/Area: 2.526298 fF/µm²
    - Cgs_ls/Area: -1.295987 fF/µm²
    - Cgd_ls/Area: -1.021107 fF/µm²
    - Cgb_ls/Area: -0.209204 fF/µm²
...
- [<span style='color: green'>✓</span>] S-parameter analysis verified
  ...
  - S21 range: -23dB to -17dB
  - S12 range: -83dB to -24dB
...
- [<span style='color: green'>✓</span>] Flicker noise analysis completed
  - Coefficient (K): 4.50e+03
  - Exponent (γ): 4.41e-01 (ideally -1.0 for pure 1/f noise)
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 2.61e-07 V²/Hz
  - Standard Deviation: 4.54e-07 V²/Hz
  - Variation Coefficient: 1.7396
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.9989296819398786
...
- Model: `sky130__fd__pr__nfet__20v0__zvt__base__expansion_translation`
- Model MD5: `22e375496bbf85efad8f6683108a2ccb`
- Simulator: `ngspice`
- Modes: `dc, transient, ac, noise`
- Started: `2026-07-28T12:49:37.114251+00:00`
- Finished: `2026-07-28T13:35:32.490602+00:00`
- Elapsed seconds: `2755.376353`
- Peak resident memory KiB: `234716`
