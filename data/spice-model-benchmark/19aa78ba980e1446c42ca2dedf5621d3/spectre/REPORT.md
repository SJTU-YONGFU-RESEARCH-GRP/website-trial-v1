...
Generated on: 2026-07-28 21:08:54
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/19aa78ba980e1446c42ca2dedf5621d3/spectre/netlist/dc.scs
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/19aa78ba980e1446c42ca2dedf5621d3/spectre/netlist/transient.scs
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/19aa78ba980e1446c42ca2dedf5621d3/spectre/netlist/ac.scs
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/19aa78ba980e1446c42ca2dedf5621d3/spectre/netlist/noise.scs
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -6.55e-05A to 0.00e+00A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -5.91e-05A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 5.91e-05A, IB: 0.00e+00A to 1.20e-12A, KCL Error: 0.00%, Power: 0.00e+00W to 7.10e-05W, Temp: -40.0°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: -0.000000 /°C, IDS: -6.546e-05A to 0.000e+00A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 7.856e-05W, Efficiency: 3.563e+00 to 9.347e+10, TC: nan/°C |
...
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.49° |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 8.709e-06A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 277.9ps, Power: 7.835e-05W (max), 4.517e-06W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 1044.5ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -2.699811e-08W/°C |
...
| [Flicker (1/f) Noise](#flicker-noise-analysis) | <span style='color: green'>✓</span> | Exponent: 0.1704, Corner Freq: not resolved |
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 7.79e-04 V²/Hz, Variation: 1.1117 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -5.91e-05A to 0.00e+00A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: 0.00e+00A to 5.91e-05A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -6.546e-05A to 0.000e+00A
...
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 3.563e+00 to 9.347e+10
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 8.709198e-06A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 277.9ps

  - Maximum Switching Power: 7.835254e-05W

  - Average Switching Power: 4.517099e-06W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 433.9ps

  - Stage 2 Delay: 351.4ps

  - Stage 3 Delay: 259.2ps

  - Total Delay: 1044.5ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 7.835254e-05W

  - Maximum Power at 100°C: 7.638168e-05W

  - Average Power at 27°C: 4.517099e-06W

  - Average Power at 100°C: 4.537902e-06W

  - Power Temperature Coefficient: -2.699811e-08W/°C
...
- [<span style='color: green'>✓</span>] Flicker noise analysis completed
  - Coefficient (K): 3.50e-04
  - Exponent (γ): 1.70e-01 (ideally -1.0 for pure 1/f noise)
  - Correlation (R²): 0.9662
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 7.79e-04 V²/Hz
  - Standard Deviation: 8.66e-04 V²/Hz
  - Variation Coefficient: 1.1117
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.997570340449236
...
- Started: `2026-07-28T13:07:42.142071+00:00`
- Finished: `2026-07-28T13:09:28.897618+00:00`
- Elapsed seconds: `106.755557`
- Peak resident memory KiB: `240544`
