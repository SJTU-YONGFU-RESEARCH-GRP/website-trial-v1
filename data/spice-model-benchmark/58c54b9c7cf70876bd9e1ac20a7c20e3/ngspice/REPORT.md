...
Generated on: 2026-07-28 22:02:33
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/58c54b9c7cf70876bd9e1ac20a7c20e3/ngspice/netlist/dc.cir
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/58c54b9c7cf70876bd9e1ac20a7c20e3/ngspice/netlist/transient.cir
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/58c54b9c7cf70876bd9e1ac20a7c20e3/ngspice/netlist/ac.cir
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/58c54b9c7cf70876bd9e1ac20a7c20e3/ngspice/netlist/noise.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: -1.20V to 0.00V, VGS: -1.20V to 0.00V, IDS: -1.23e-32A to 2.30e-05A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -2.29e-42A to 6.45e-06A, IG: 0.00e+00A to 0.00e+00A, IS: -6.45e-06A to 2.71e-42A, IB: -5.46e-13A to 1.05e-53A, KCL Error: 0.00%, Power: 0.00e+00W to 7.74e-06W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000000 /°C, IDS: -1.235e-32A to 2.296e-05A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 2.755e-05W, Efficiency: 2.152e-04 to 6.996e+09, TC: 5.76e-02/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 19.88fF to 77.27fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -100dB to -51dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 107.397 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 5.203e-05A, Rise Time: 0.0ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 490.4ps, Power: 2.185e-04W (max), 9.735e-07W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 9365.3ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: 3.247548e-07W/°C |
...
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 1.32e-08 V²/Hz, Variation: 0.0659 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -2.29e-42A to 6.45e-06A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: -6.45e-06A to 2.71e-42A
  - IB: -5.46e-13A to 1.05e-53A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -1.235e-32A to 2.296e-05A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 2.755e-05W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 2.152e-04 to 6.996e+09
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: 5.76e-02/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 5.202718e-05A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 490.4ps

  - Maximum Switching Power: 2.185007e-04W

  - Average Switching Power: 9.735020e-07W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 975.3ps

  - Stage 2 Delay: 5940.0ps

  - Stage 3 Delay: 2450.0ps

  - Total Delay: 9365.3ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 2.185007e-04W

  - Maximum Power at 100°C: 2.422078e-04W

  - Average Power at 27°C: 9.735020e-07W

  - Average Power at 100°C: 6.613663e-07W

  - Power Temperature Coefficient: 3.247548e-07W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 19.88fF to 77.27fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 4.429533 fF/µm²
    - Cgs_ls/Area: -0.421509 fF/µm²
    - Cgd_ls/Area: -0.302550 fF/µm²
    - Cgb_ls/Area: -3.705473 fF/µm²
...
- [<span style='color: green'>✓</span>] S-parameter analysis verified
  ...
  - S21 range: -100dB to -51dB
  - S12 range: -127dB to -67dB
...
- [<span style='color: green'>✓</span>] Flicker noise analysis completed
  ...
  - Exponent (γ): 1.77e-08 (ideally -1.0 for pure 1/f noise)
  - Correlation (R²): 0.5142
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 1.32e-08 V²/Hz
  - Standard Deviation: 8.70e-10 V²/Hz
  - Variation Coefficient: 0.0659
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.998929681939827
...
- Model: `sky130__fd__pr__pfet__01v8__hvt__model__expansion_translation`
- Model MD5: `58c54b9c7cf70876bd9e1ac20a7c20e3`
- Simulator: `ngspice`
- Modes: `dc, transient, ac, noise`
- Started: `2026-07-28T13:17:13.099795+00:00`
- Finished: `2026-07-28T14:03:10.059943+00:00`
- Elapsed seconds: `2756.960162`
- Peak resident memory KiB: `222320`
