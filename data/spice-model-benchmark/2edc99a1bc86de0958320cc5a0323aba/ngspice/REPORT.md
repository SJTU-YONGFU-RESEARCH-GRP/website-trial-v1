...
Generated on: 2026-07-28 22:41:45
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/2edc99a1bc86de0958320cc5a0323aba/ngspice/netlist/dc.cir
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/2edc99a1bc86de0958320cc5a0323aba/ngspice/netlist/transient.cir
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/2edc99a1bc86de0958320cc5a0323aba/ngspice/netlist/ac.cir
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/2edc99a1bc86de0958320cc5a0323aba/ngspice/netlist/noise.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: -1.20V to 0.00V, VGS: -1.20V to 0.00V, IDS: -2.18e-36A to 2.90e-05A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -4.05e-47A to 1.03e-05A, IG: 0.00e+00A to 0.00e+00A, IS: -1.03e-05A to 3.63e-47A, IB: -1.23e-15A to 4.17e-48A, KCL Error: 0.00%, Power: 0.00e+00W to 1.24e-05W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000000 /°C, IDS: -2.176e-36A to 2.895e-05A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 3.474e-05W, Efficiency: 2.196e+00 to 1.551e+10, TC: 5.13e-02/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 12.33fF to 29.01fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -92dB to -53dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 135.965 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 2.774e-05A, Rise Time: 0.0ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 426.6ps, Power: 9.930e-05W (max), 1.113e-06W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 4173.2ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: 3.455501e-07W/°C |
...
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 1.48e-08 V²/Hz, Variation: 0.3292 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -4.05e-47A to 1.03e-05A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: -1.03e-05A to 3.63e-47A
  - IB: -1.23e-15A to 4.17e-48A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -2.176e-36A to 2.895e-05A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 3.474e-05W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 2.196e+00 to 1.551e+10
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: 5.13e-02/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 2.774210e-05A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 426.6ps

  - Maximum Switching Power: 9.929899e-05W

  - Average Switching Power: 1.113368e-06W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 676.6ps

  - Stage 2 Delay: 2276.5ps

  - Stage 3 Delay: 1220.0ps

  - Total Delay: 4173.2ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 9.929899e-05W

  - Maximum Power at 100°C: 1.245241e-04W

  - Average Power at 27°C: 1.113368e-06W

  - Average Power at 100°C: 1.083009e-06W

  - Power Temperature Coefficient: 3.455501e-07W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 12.33fF to 29.01fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 1.828643 fF/µm²
    - Cgs_ls/Area: -0.335541 fF/µm²
    - Cgd_ls/Area: -0.291934 fF/µm²
    - Cgb_ls/Area: -1.201169 fF/µm²
...
- [<span style='color: green'>✓</span>] Flicker noise analysis completed
  ...
  - Exponent (γ): 5.38e-06 (ideally -1.0 for pure 1/f noise)
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Standard Deviation: 4.89e-09 V²/Hz
  - Variation Coefficient: 0.3292
...
- Model: `sky130__fd__pr__pfet__g5v0d10v5__model__original`
- Model MD5: `2edc99a1bc86de0958320cc5a0323aba`
- Simulator: `ngspice`
- Modes: `dc, transient, ac, noise`
- Started: `2026-07-28T14:02:12.469272+00:00`
- Finished: `2026-07-28T14:42:19.325649+00:00`
- Elapsed seconds: `2406.856391`
- Peak resident memory KiB: `229540`
