...
Generated on: 2026-07-29 00:21:37
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/b32717b6edcf635c491eec3cce7c9463/ngspice/netlist/dc.cir
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/b32717b6edcf635c491eec3cce7c9463/ngspice/netlist/transient.cir
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/b32717b6edcf635c491eec3cce7c9463/ngspice/netlist/ac.cir
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/b32717b6edcf635c491eec3cce7c9463/ngspice/netlist/noise.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: -1.20V to 0.00V, VGS: -1.20V to 0.00V, IDS: 0.00e+00A to 3.31e-06A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: 0.00e+00A to 2.02e-06A, IG: 0.00e+00A to 0.00e+00A, IS: -2.02e-06A to 0.00e+00A, IB: -1.12e-14A to 0.00e+00A, KCL Error: 0.00%, Power: 0.00e+00W to 2.43e-06W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000000 /°C, IDS: 0.000e+00A to 3.314e-06A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 3.977e-06W, Efficiency: 7.382e+00 to 4.174e+03, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 0.10fF to 0.22fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: 0dB to 0dB, S21 range: -97dB to -92dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.175 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 2.159e-06A, Rise Time: 0.0ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 150.0ps, Power: 2.734e-06W (max), 7.893e-08W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 802.2ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: 1.415554e-08W/°C |
...
| [Shot Noise](#shot-noise-analysis) | <span style='color: green'>✓</span> | Level: 1.29e-08 V²/Hz, Variation: 0.0000 |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: 0.00e+00A to 2.02e-06A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: -2.02e-06A to 0.00e+00A
  - IB: -1.12e-14A to 0.00e+00A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: 0.000e+00A to 3.314e-06A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 3.977e-06W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 7.382e+00 to 4.174e+03
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 2.159100e-06A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  ...
  - Maximum Switching Power: 2.734406e-06W

  - Average Switching Power: 7.893241e-08W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 160.0ps

  - Stage 2 Delay: 422.2ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 2.734406e-06W

  - Maximum Power at 100°C: 3.767760e-06W

  - Average Power at 27°C: 7.893241e-08W

  - Average Power at 100°C: 8.076686e-08W

  - Power Temperature Coefficient: 1.415554e-08W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 0.10fF to 0.22fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    - Geometry: W=0.13975 µm, L=0.15025 µm, Area=0.0209974 µm²
    - Cgg_ls/Area: 6.717422 fF/µm²
    - Cgs_ls/Area: -1.893861 fF/µm²
    - Cgd_ls/Area: -1.779248 fF/µm²
    - Cgb_ls/Area: -3.044316 fF/µm²
...
- [<span style='color: green'>✓</span>] S-parameter analysis verified
  ...
  - S21 range: -97dB to -92dB
  - S12 range: -153dB to -93dB
...
- [<span style='color: green'>✓</span>] Flicker noise analysis completed
  ...
  - Exponent (γ): -3.18e-16 (ideally -1.0 for pure 1/f noise)
  - Correlation (R²): *Not measured*
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  - Shot Noise Level: 1.29e-08 V²/Hz
  - Standard Deviation: 2.09e-24 V²/Hz
...
- Model: `sky130__fd__pr__special__pfet__pass__model__fitting_reduction_translation`
- Model MD5: `b32717b6edcf635c491eec3cce7c9463`
- Simulator: `ngspice`
- Modes: `dc, transient, ac, noise`
- Started: `2026-07-28T15:57:01.141422+00:00`
- Finished: `2026-07-28T16:21:55.101408+00:00`
- Elapsed seconds: `1493.959985`
- Peak resident memory KiB: `237292`
