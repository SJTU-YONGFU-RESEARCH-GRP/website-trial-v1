...
Generated on: 2026-07-28 21:48:21
...
- [<span style='color: green'>✓</span>] Circuit files exist and are readable
  - DC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/84b7a2781f45693a3bcc4df013e8b5e0/ngspice/netlist/dc.cir
  - TRANSIENT: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/84b7a2781f45693a3bcc4df013e8b5e0/ngspice/netlist/transient.cir
  - AC: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/84b7a2781f45693a3bcc4df013e8b5e0/ngspice/netlist/ac.cir
  - NOISE: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/84b7a2781f45693a3bcc4df013e8b5e0/ngspice/netlist/noise.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -9.91e-05A to 1.90e-37A |
...
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: -0.000000 /°C, IDS: -9.907e-05A to 1.899e-37A |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 16.75fF to 26.74fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -50dB to -44dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 178.955 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 2.109e-05A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 282.2ps, Power: 7.727e-05W (max), 7.286e-07W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 1472.2ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: 1.791143e-08W/°C |
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -9.907e-05A to 1.899e-37A
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 2.109475e-05A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 282.2ps

  - Maximum Switching Power: 7.727272e-05W

  - Average Switching Power: 7.285756e-07W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 501.8ps

  - Stage 2 Delay: 570.4ps

  - Stage 3 Delay: 400.0ps

  - Total Delay: 1472.2ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 7.727272e-05W

  - Maximum Power at 100°C: 7.858025e-05W

  - Average Power at 27°C: 7.285756e-07W

  - Average Power at 100°C: 7.473351e-07W

  - Power Temperature Coefficient: 1.791143e-08W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 16.75fF to 26.74fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 2.156267 fF/µm²
    - Cgs_ls/Area: -0.690295 fF/µm²
    - Cgd_ls/Area: -0.549786 fF/µm²
...
- [<span style='color: green'>✓</span>] Short noise analysis completed
  ...
  - Temperature-Noise Correlation: 0.9989296819398137
...
- Model: `sky130__fd__pr__nfet__g5v0d10v5__model__original`
- Model MD5: `84b7a2781f45693a3bcc4df013e8b5e0`
- Simulator: `ngspice`
- Modes: `dc, transient, ac, noise`
- Started: `2026-07-28T13:02:48.654656+00:00`
- Finished: `2026-07-28T13:49:00.479876+00:00`
- Elapsed seconds: `2771.825235`
- Peak resident memory KiB: `226432`
