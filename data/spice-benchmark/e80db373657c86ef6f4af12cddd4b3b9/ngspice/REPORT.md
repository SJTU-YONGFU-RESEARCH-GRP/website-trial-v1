...
Generated on: 2026-07-27 05:49:54
...
- [<span style='color: green'>✓</span>] Circuit file exists and is readable
  - Path: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/e80db373657c86ef6f4af12cddd4b3b9/ngspice/_ngspice_netlists/dc_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/e80db373657c86ef6f4af12cddd4b3b9/ngspice/_ngspice_netlists/transient_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/e80db373657c86ef6f4af12cddd4b3b9/ngspice/_ngspice_netlists/noise_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/e80db373657c86ef6f4af12cddd4b3b9/ngspice/_ngspice_netlists/ac_circuit.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -8.27e-04A to 0.00e+00A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -6.02e-04A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 6.02e-04A, IB: 0.00e+00A to 1.20e-15A, KCL Error: 0.00%, Power: 0.00e+00W to 7.22e-04W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000000 /°C, IDS: -8.269e-04A to 0.000e+00A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 9.923e-04W, Efficiency: 2.490e+00 to 1.610e+11, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 28.05fF to 89.58fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -22dB to -22dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.863 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 5.526e-05A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 288.2ps, Power: 6.375e-04W (max), 3.934e-05W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 2093.1ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -7.496572e-07W/°C |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -6.02e-04A to 0.00e+00A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: 0.00e+00A to 6.02e-04A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -8.269e-04A to 0.000e+00A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 9.923e-04W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 2.490e+00 to 1.610e+11
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 5.526073e-05A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 288.2ps

  - Maximum Switching Power: 6.375411e-04W

  - Average Switching Power: 3.933683e-05W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 491.2ps

  - Stage 2 Delay: 1086.2ps

  - Stage 3 Delay: 515.7ps

  - Total Delay: 2093.1ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 6.375411e-04W

  - Maximum Power at 100°C: 5.828161e-04W

  - Average Power at 27°C: 3.933683e-05W

  - Average Power at 100°C: 2.982319e-05W

  - Power Temperature Coefficient: -7.496572e-07W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 28.05fF to 89.58fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 5.362720 fF/µm²
    - Cgs_ls/Area: -1.408210 fF/µm²
    - Cgd_ls/Area: -1.061432 fF/µm²
    - Cgb_ls/Area: -2.893078 fF/µm²
...
- Started: `2026-07-26T21:48:19.999057+00:00`
- Finished: `2026-07-26T21:49:54.500124+00:00`
- Elapsed seconds: `94.50107`
- Peak resident memory KiB: `201652`
