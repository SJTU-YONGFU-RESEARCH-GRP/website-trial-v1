...
| Temperature Analysis | ✓ | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000017 /°C |
...
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Large-Signal Transient | ✓ | Max Current: 2.568e-05A, Rise Time: 0.1ps |
...
| Drain current properly measured | ✓ | Range: -1.82e-02 to 2.86e-08A |

### Temperature Dependence
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Temperature sweep performed | ✓ | Points: [-40, 0, 25, 50, 100, 150] |
| Temperature coefficient calculated | ✓ | TC: 0.000017 /°C |
...
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Large Signal Transient Verified | ✓ | Max Drain Current: 2.568e-05A |
