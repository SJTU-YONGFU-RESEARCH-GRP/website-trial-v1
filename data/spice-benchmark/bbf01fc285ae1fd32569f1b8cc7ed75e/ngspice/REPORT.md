...
Generated on: 2026-07-27 06:11:38
...
- [<span style='color: green'>✓</span>] Circuit file exists and is readable
  - Path: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/bbf01fc285ae1fd32569f1b8cc7ed75e/ngspice/_ngspice_netlists/dc_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/bbf01fc285ae1fd32569f1b8cc7ed75e/ngspice/_ngspice_netlists/transient_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/bbf01fc285ae1fd32569f1b8cc7ed75e/ngspice/_ngspice_netlists/noise_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/bbf01fc285ae1fd32569f1b8cc7ed75e/ngspice/_ngspice_netlists/ac_circuit.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -1.03e-03A to 0.00e+00A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -7.60e-04A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 7.60e-04A, IB: 0.00e+00A to 1.20e-15A, KCL Error: 0.00%, Power: 0.00e+00W to 9.12e-04W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000001 /°C, IDS: -1.032e-03A to 0.000e+00A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 1.238e-03W, Efficiency: 2.641e+00 to 2.219e+10, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 23.70fF to 84.16fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -20dB to -20dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.904 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 4.384e-05A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 269.6ps, Power: 1.754e-03W (max), 1.229e-04W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 1683.3ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -1.185342e-06W/°C |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -7.60e-04A to 0.00e+00A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: 0.00e+00A to 7.60e-04A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -1.032e-03A to 0.000e+00A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 1.238e-03W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 2.641e+00 to 2.219e+10
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 4.383717e-05A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 269.6ps

  - Maximum Switching Power: 1.753994e-03W

  - Average Switching Power: 1.228725e-04W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 468.3ps

  - Stage 2 Delay: 899.2ps

  - Stage 3 Delay: 315.9ps

  - Total Delay: 1683.3ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 1.753994e-03W

  - Maximum Power at 100°C: 1.667464e-03W

  - Average Power at 27°C: 1.228725e-04W

  - Average Power at 100°C: 1.068695e-04W

  - Power Temperature Coefficient: -1.185342e-06W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 23.70fF to 84.16fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 5.158310 fF/µm²
    - Cgs_ls/Area: -1.151687 fF/µm²
    - Cgd_ls/Area: -0.806206 fF/µm²
    - Cgb_ls/Area: -3.200420 fF/µm²
...
- Started: `2026-07-26T22:09:19.964948+00:00`
- Finished: `2026-07-26T22:11:38.880178+00:00`
- Elapsed seconds: `138.915226`
- Peak resident memory KiB: `207328`
