# MOSFET Simulation Verification Report — [SkyWater130][ngspice] NMOS-BSIM4.8 (spectre)
...
| Switching Simulations | ✓ | Propagation Delay: 13.4ps |
...
| Drain current properly measured | ✓ | Range: -1.77e-02 to 2.76e-08A |
...
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Propagation Delay Verified | ✓ | 13.4ps |
