...
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Large-Signal Transient | ✓ | Max Current: 3.051e-05A, Rise Time: 0.1ps |
| Switching Simulations | ✓ | Propagation Delay: 9.5ps |
...
| Drain current properly measured | ✓ | Range: -1.74e-02 to 2.78e-08A |
...
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Large Signal Transient Verified | ✓ | Max Drain Current: 3.051e-05A |

### Switching Simulations
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Propagation Delay Verified | ✓ | 9.5ps |
