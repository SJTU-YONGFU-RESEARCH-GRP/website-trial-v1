...
Generated on: 2026-07-27 06:03:53
...
- [<span style='color: green'>✓</span>] Circuit file exists and is readable
  - Path: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/42e7f6b681b3fa1edc7e3c66e61bfc9d/ngspice/_ngspice_netlists/dc_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/42e7f6b681b3fa1edc7e3c66e61bfc9d/ngspice/_ngspice_netlists/transient_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/42e7f6b681b3fa1edc7e3c66e61bfc9d/ngspice/_ngspice_netlists/noise_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/42e7f6b681b3fa1edc7e3c66e61bfc9d/ngspice/_ngspice_netlists/ac_circuit.cir
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 49.00fF to 318.19fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -31dB to -26dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.213 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 1.406e-04A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 496.3ps, Power: 1.269e-03W (max), 2.640e-05W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 3807.9ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -9.470367e-07W/°C |
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 1.405836e-04A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 496.3ps

  - Maximum Switching Power: 1.269086e-03W

  - Average Switching Power: 2.639786e-05W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 1043.8ps

  - Stage 2 Delay: 1921.0ps

  - Stage 3 Delay: 843.1ps

  - Total Delay: 3807.9ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 1.269086e-03W

  - Maximum Power at 100°C: 1.199952e-03W

  - Average Power at 27°C: 2.639786e-05W

  - Average Power at 100°C: 2.277122e-05W

  - Power Temperature Coefficient: -9.470367e-07W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 49.00fF to 318.19fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Cgg_ls: 158.236850 fF
  - Cgs_ls: -29.036690 fF
  - Cgd_ls: -20.023490 fF
  - Cgb_ls: -109.176750 fF
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 15.823685 fF/µm²
    - Cgs_ls/Area: -2.903669 fF/µm²
    - Cgd_ls/Area: -2.002349 fF/µm²
    - Cgb_ls/Area: -10.917675 fF/µm²
...
- Started: `2026-07-26T22:02:04.714628+00:00`
- Finished: `2026-07-26T22:03:54.160770+00:00`
- Elapsed seconds: `109.446136`
- Peak resident memory KiB: `209408`
