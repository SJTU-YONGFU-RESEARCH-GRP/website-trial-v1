# MOSFET Simulation Verification Report — [SkyWater130][ngspice] NMOS-BSIM4.8 (hspice)
...
| hspice is properly installed | ✓ | hspice-2024.03 |
...
| Temperature Analysis | ✓ | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000015 /°C |
...
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Large-Signal Transient | ✓ | Max Current: 3.285e-05A, Rise Time: 0.1ps |
| Switching Simulations | ✓ | Propagation Delay: 15.5ps |
...
| Drain current properly measured | ✓ | Range: -1.85e-02 to 2.78e-08A |

### Temperature Dependence
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Temperature sweep performed | ✓ | Points: [-40, 0, 25, 50, 100, 150] |
| Temperature coefficient calculated | ✓ | TC: 0.000015 /°C |
...
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Large Signal Transient Verified | ✓ | Max Drain Current: 3.285e-05A |

### Switching Simulations
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Propagation Delay Verified | ✓ | 15.5ps |
