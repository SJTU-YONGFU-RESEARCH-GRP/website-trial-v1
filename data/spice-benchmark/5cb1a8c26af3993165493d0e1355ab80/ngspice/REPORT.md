...
Generated on: 2026-07-27 02:09:25
...
- [<span style='color: green'>✓</span>] Circuit file exists and is readable
  - Path: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/5cb1a8c26af3993165493d0e1355ab80/ngspice/_ngspice_netlists/dc_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/5cb1a8c26af3993165493d0e1355ab80/ngspice/_ngspice_netlists/transient_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/5cb1a8c26af3993165493d0e1355ab80/ngspice/_ngspice_netlists/noise_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/5cb1a8c26af3993165493d0e1355ab80/ngspice/_ngspice_netlists/ac_circuit.cir
...
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -1.23e-07A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 1.23e-07A, IB: 0.00e+00A to 1.20e-15A, KCL Error: 0.00%, Power: 0.00e+00W to 1.47e-07W, Temp: -40°C |
...
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 4.941e-07W, Efficiency: 1.005e+01 to 2.415e+02, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 42.62fF to 141.95fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -103dB to -43dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 90.0007 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 1.462e-04A, Rise Time: 0.1ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 45.3ps, Power: 6.874e-05W (max), 4.937e-06W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 83.4ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -1.238714e-07W/°C |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -1.23e-07A to 0.00e+00A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: 0.00e+00A to 1.23e-07A
...
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 1.005e+01 to 2.415e+02
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 1.462165e-04A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 45.3ps

  - Maximum Switching Power: 6.874288e-05W

  - Average Switching Power: 4.937051e-06W
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 6.874288e-05W

  - Maximum Power at 100°C: 5.970027e-05W

  - Average Power at 27°C: 4.937051e-06W

  - Average Power at 100°C: 4.558654e-06W

  - Power Temperature Coefficient: -1.238714e-07W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 42.62fF to 141.95fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 8.551717 fF/µm²
    - Cgs_ls/Area: -1.145876 fF/µm²
    - Cgd_ls/Area: -1.145141 fF/µm²
    - Cgb_ls/Area: -6.260708 fF/µm²
...
- Started: `2026-07-26T17:59:51.080035+00:00`
- Finished: `2026-07-26T18:09:25.974484+00:00`
- Elapsed seconds: `574.894462`
- Peak resident memory KiB: `202124`
