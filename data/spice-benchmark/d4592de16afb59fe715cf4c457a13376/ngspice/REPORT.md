...
Generated on: 2026-07-27 03:06:08
...
- [<span style='color: green'>✓</span>] Circuit file exists and is readable
  - Path: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/d4592de16afb59fe715cf4c457a13376/ngspice/_ngspice_netlists/dc_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/d4592de16afb59fe715cf4c457a13376/ngspice/_ngspice_netlists/transient_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/d4592de16afb59fe715cf4c457a13376/ngspice/_ngspice_netlists/noise_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/d4592de16afb59fe715cf4c457a13376/ngspice/_ngspice_netlists/ac_circuit.cir
...
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -3.19e-04A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 3.19e-04A, IB: 0.00e+00A to 1.20e-15A, KCL Error: 0.00%, Power: 0.00e+00W to 3.83e-04W, Temp: -40°C |
...
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 5.278e-04W, Efficiency: 2.596e+00 to 1.199e+10, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 45.90fF to 106.09fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -27dB to -26dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.674 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 4.263e-04A, Rise Time: 0.1ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 45.1ps, Power: 6.874e-05W (max), 4.134e-06W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 83.4ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -1.238308e-07W/°C |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -3.19e-04A to 0.00e+00A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: 0.00e+00A to 3.19e-04A
...
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 2.596e+00 to 1.199e+10
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 4.262610e-04A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 45.1ps

  - Maximum Switching Power: 6.873962e-05W

  - Average Switching Power: 4.134371e-06W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 45.1ps

  - Stage 2 Delay: 19.2ps

  - Stage 3 Delay: 19.1ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 6.873962e-05W

  - Maximum Power at 100°C: 5.969997e-05W

  - Average Power at 27°C: 4.134371e-06W

  - Average Power at 100°C: 4.029459e-06W

  - Power Temperature Coefficient: -1.238308e-07W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 45.90fF to 106.09fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 7.256330 fF/µm²
    - Cgs_ls/Area: -2.626598 fF/µm²
    - Cgd_ls/Area: -2.134015 fF/µm²
    - Cgb_ls/Area: -2.495723 fF/µm²
...
- Started: `2026-07-26T18:56:33.624120+00:00`
- Finished: `2026-07-26T19:06:08.725456+00:00`
- Elapsed seconds: `575.101346`
- Peak resident memory KiB: `208440`
