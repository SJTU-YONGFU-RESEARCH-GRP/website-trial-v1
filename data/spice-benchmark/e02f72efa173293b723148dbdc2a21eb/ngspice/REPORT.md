...
Generated on: 2026-07-27 06:15:22
...
- [<span style='color: green'>✓</span>] Circuit file exists and is readable
  - Path: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/e02f72efa173293b723148dbdc2a21eb/ngspice/_ngspice_netlists/dc_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/e02f72efa173293b723148dbdc2a21eb/ngspice/_ngspice_netlists/transient_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/e02f72efa173293b723148dbdc2a21eb/ngspice/_ngspice_netlists/noise_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/e02f72efa173293b723148dbdc2a21eb/ngspice/_ngspice_netlists/ac_circuit.cir
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 42.97fF to 206.54fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -14dB to -14dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.882 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 1.143e-04A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 253.7ps, Power: 1.336e-03W (max), 6.815e-05W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 2192.6ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -1.698349e-06W/°C |
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 1.142905e-04A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 253.7ps

  - Maximum Switching Power: 1.335501e-03W

  - Average Switching Power: 6.814957e-05W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 417.2ps

  - Stage 2 Delay: 1226.6ps

  - Stage 3 Delay: 548.8ps

  - Total Delay: 2192.6ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 1.335501e-03W

  - Maximum Power at 100°C: 1.211522e-03W

  - Average Power at 27°C: 6.814957e-05W

  - Average Power at 100°C: 4.953333e-05W

  - Power Temperature Coefficient: -1.698349e-06W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 42.97fF to 206.54fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 10.321015 fF/µm²
    - Cgs_ls/Area: -2.831311 fF/µm²
    - Cgd_ls/Area: -1.984059 fF/µm²
    - Cgb_ls/Area: -5.505640 fF/µm²
...
- Started: `2026-07-26T22:13:14.544251+00:00`
- Finished: `2026-07-26T22:15:22.793528+00:00`
- Elapsed seconds: `128.249284`
- Peak resident memory KiB: `187636`
