...
Generated on: 2026-07-27 05:59:37
...
- [<span style='color: green'>✓</span>] Circuit file exists and is readable
  - Path: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/f141fba2b8af8f1adad9688ed62d32e2/ngspice/_ngspice_netlists/dc_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/f141fba2b8af8f1adad9688ed62d32e2/ngspice/_ngspice_netlists/transient_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/f141fba2b8af8f1adad9688ed62d32e2/ngspice/_ngspice_netlists/noise_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/f141fba2b8af8f1adad9688ed62d32e2/ngspice/_ngspice_netlists/ac_circuit.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -1.24e-03A to 0.00e+00A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -1.02e-03A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 1.02e-03A, IB: 0.00e+00A to 1.20e-15A, KCL Error: 0.00%, Power: 0.00e+00W to 1.23e-03W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000000 /°C, IDS: -1.242e-03A to 0.000e+00A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 1.490e-03W, Efficiency: 2.050e+00 to 5.000e+10, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 51.05fF to 299.91fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -17dB to -16dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.767 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 1.836e-04A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 330.5ps, Power: 1.866e-03W (max), 6.181e-05W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 2794.2ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -1.513822e-06W/°C |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -1.02e-03A to 0.00e+00A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: 0.00e+00A to 1.02e-03A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -1.242e-03A to 0.000e+00A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 1.490e-03W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 2.050e+00 to 5.000e+10
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 1.836079e-04A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 330.5ps

  - Maximum Switching Power: 1.865847e-03W

  - Average Switching Power: 6.181411e-05W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 658.7ps

  - Stage 2 Delay: 1473.5ps

  - Stage 3 Delay: 662.0ps

  - Total Delay: 2794.2ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 1.865847e-03W

  - Maximum Power at 100°C: 1.755338e-03W

  - Average Power at 27°C: 6.181411e-05W

  - Average Power at 100°C: 7.033021e-05W

  - Power Temperature Coefficient: -1.513822e-06W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 51.05fF to 299.91fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Cgg_ls: 168.260000 fF
  - Cgs_ls: -39.633033 fF
  - Cgd_ls: -27.134183 fF
  - Cgb_ls: -101.492800 fF
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 16.826000 fF/µm²
    - Cgs_ls/Area: -3.963303 fF/µm²
    - Cgd_ls/Area: -2.713418 fF/µm²
    - Cgb_ls/Area: -10.149280 fF/µm²
...
- Started: `2026-07-26T21:58:51.411312+00:00`
- Finished: `2026-07-26T21:59:38.045086+00:00`
- Elapsed seconds: `46.633764`
- Peak resident memory KiB: `191668`
