# MOSFET Simulation Verification Report — [SkyWater130][ngspice] NMOS-BSIM4.8 (ngspice)
...
| ngspice is properly installed | ✓ | ngspice-45+ |
...
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Large-Signal Transient | ✓ | Max Current: 2.877e-05A, Rise Time: 0.1ps |
| Switching Simulations | ✓ | Propagation Delay: 12.1ps |
...
| Drain current properly measured | ✓ | Range: -1.84e-02 to 2.62e-08A |
...
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Large Signal Transient Verified | ✓ | Max Drain Current: 2.877e-05A |

### Switching Simulations
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Propagation Delay Verified | ✓ | 12.1ps |
