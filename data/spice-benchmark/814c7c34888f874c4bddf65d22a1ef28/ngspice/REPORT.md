...
Generated on: 2026-07-27 06:25:17
...
- [<span style='color: green'>✓</span>] Circuit file exists and is readable
  - Path: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/814c7c34888f874c4bddf65d22a1ef28/ngspice/_ngspice_netlists/dc_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/814c7c34888f874c4bddf65d22a1ef28/ngspice/_ngspice_netlists/transient_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/814c7c34888f874c4bddf65d22a1ef28/ngspice/_ngspice_netlists/noise_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/814c7c34888f874c4bddf65d22a1ef28/ngspice/_ngspice_netlists/ac_circuit.cir
...
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -9.14e-04A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 9.14e-04A, IB: 0.00e+00A to 1.20e-15A, KCL Error: 0.00%, Power: 0.00e+00W to 1.10e-03W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000001 /°C, IDS: -1.236e-03A to 0.000e+00A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 1.483e-03W, Efficiency: 2.895e+00 to 1.100e+11, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 23.01fF to 84.58fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -18dB to -18dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.918 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 4.356e-05A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 270.8ps, Power: 1.194e-03W (max), 1.001e-04W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 1894.7ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -4.832000e-07W/°C |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -9.14e-04A to 0.00e+00A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: 0.00e+00A to 9.14e-04A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -1.236e-03A to 0.000e+00A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 1.483e-03W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 2.895e+00 to 1.100e+11
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 4.356375e-05A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 270.8ps

  - Maximum Switching Power: 1.193749e-03W

  - Average Switching Power: 1.001177e-04W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 446.8ps

  - Stage 2 Delay: 1013.0ps

  - Stage 3 Delay: 434.9ps

  - Total Delay: 1894.7ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 1.193749e-03W

  - Maximum Power at 100°C: 1.158476e-03W

  - Average Power at 27°C: 1.001177e-04W

  - Average Power at 100°C: 6.530235e-05W

  - Power Temperature Coefficient: -4.832000e-07W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 23.01fF to 84.58fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 4.851648 fF/µm²
    - Cgs_ls/Area: -1.157753 fF/µm²
    - Cgd_ls/Area: -0.810912 fF/µm²
    - Cgb_ls/Area: -2.882980 fF/µm²
...
- Started: `2026-07-26T22:23:59.826024+00:00`
- Finished: `2026-07-26T22:25:17.960677+00:00`
- Elapsed seconds: `78.134656`
- Peak resident memory KiB: `207612`
