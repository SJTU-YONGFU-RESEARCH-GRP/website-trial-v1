...
Generated on: 2026-07-27 05:40:57
...
- [<span style='color: green'>✓</span>] Circuit file exists and is readable
  - Path: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/9add38218f66d4ae56bdbb568091226d/ngspice/_ngspice_netlists/dc_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/9add38218f66d4ae56bdbb568091226d/ngspice/_ngspice_netlists/transient_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/9add38218f66d4ae56bdbb568091226d/ngspice/_ngspice_netlists/noise_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/9add38218f66d4ae56bdbb568091226d/ngspice/_ngspice_netlists/ac_circuit.cir
...
|-----------|--------|-------------|
| [DC Operating Point Analysis](#dc-operating-point-analysis) | <span style='color: green'>✓</span> | VDS: 0.00V to 1.20V, VGS: 0.00V to 1.20V, IDS: -2.21e-03A to 0.00e+00A |
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -1.66e-03A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 1.66e-03A, IB: 0.00e+00A to 1.20e-15A, KCL Error: 0.00%, Power: 0.00e+00W to 1.99e-03W, Temp: -40°C |
| [Temperature Analysis](#temperature-analysis) | <span style='color: green'>✓</span> | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000001 /°C, IDS: -2.208e-03A to 0.000e+00A |
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 2.650e-03W, Efficiency: 2.825e+00 to 1.162e+11, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 38.06fF to 159.14fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -13dB to -13dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.915 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 5.208e-04A, Rise Time: 0.1ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 130.7ps, Power: 3.832e-03W (max), 1.577e-04W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 1381.0ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -2.499124e-06W/°C |
...
- [<span style='color: green'>✓</span>] Current Range
  - IDS: -1.66e-03A to 0.00e+00A
  - IG: 0.00e+00A to 0.00e+00A
  - IS: 0.00e+00A to 1.66e-03A
...
- [<span style='color: green'>✓</span>] Device behavior is valid
  - Current Range: -2.208e-03A to 0.000e+00A
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 2.650e-03W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 2.825e+00 to 1.162e+11
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 5.208272e-04A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 130.7ps

  - Maximum Switching Power: 3.831898e-03W

  - Average Switching Power: 1.577468e-04W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 260.5ps

  - Stage 2 Delay: 807.7ps

  - Stage 3 Delay: 312.8ps

  - Total Delay: 1381.0ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 3.831898e-03W

  - Maximum Power at 100°C: 3.649462e-03W

  - Average Power at 27°C: 1.577468e-04W

  - Average Power at 100°C: 1.327088e-04W

  - Power Temperature Coefficient: -2.499124e-06W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 38.06fF to 159.14fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 8.288847 fF/µm²
    - Cgs_ls/Area: -2.274585 fF/µm²
    - Cgd_ls/Area: -1.632620 fF/µm²
    - Cgb_ls/Area: -4.381643 fF/µm²
...
- Started: `2026-07-26T21:21:28.252430+00:00`
- Finished: `2026-07-26T21:40:58.308712+00:00`
- Elapsed seconds: `1170.056258`
- Peak resident memory KiB: `218280`
