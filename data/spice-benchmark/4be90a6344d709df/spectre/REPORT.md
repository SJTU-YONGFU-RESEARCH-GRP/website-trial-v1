...
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Large-Signal Transient | ✓ | Max Current: 2.989e-05A, Rise Time: 0.1ps |
...
| Drain current properly measured | ✓ | Range: -1.71e-02 to 2.89e-08A |
...
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Large Signal Transient Verified | ✓ | Max Drain Current: 2.989e-05A |
