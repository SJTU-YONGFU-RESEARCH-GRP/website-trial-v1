...
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Large-Signal Transient | ✓ | Max Current: 3.491e-05A, Rise Time: 0.1ps |
...
| Drain current properly measured | ✓ | Range: -1.79e-02 to 2.80e-08A |
...
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Large Signal Transient Verified | ✓ | Max Drain Current: 3.491e-05A |
