...
| Temperature Analysis | ✓ | Temp Points: [-40, 0, 25, 50, 100, 150], TC: 0.000013 /°C |
...
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Large-Signal Transient | ✓ | Max Current: 3.061e-05A, Rise Time: 0.1ps |
| Switching Simulations | ✓ | Propagation Delay: 9.8ps |
...
| Drain current properly measured | ✓ | Range: -1.81e-02 to 2.90e-08A |

### Temperature Dependence
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Temperature sweep performed | ✓ | Points: [-40, 0, 25, 50, 100, 150] |
| Temperature coefficient calculated | ✓ | TC: 0.000013 /°C |
...
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Large Signal Transient Verified | ✓ | Max Drain Current: 3.061e-05A |

### Switching Simulations
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Propagation Delay Verified | ✓ | 9.8ps |
