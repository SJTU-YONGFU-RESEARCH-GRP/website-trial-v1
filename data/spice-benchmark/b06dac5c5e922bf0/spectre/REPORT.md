...
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Large-Signal Transient | ✓ | Max Current: 2.600e-05A, Rise Time: 0.1ps |
| Switching Simulations | ✓ | Propagation Delay: 11.7ps |
...
| Drain current properly measured | ✓ | Range: -1.82e-02 to 2.82e-08A |
...
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Large Signal Transient Verified | ✓ | Max Drain Current: 2.600e-05A |

### Switching Simulations
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Propagation Delay Verified | ✓ | 11.7ps |
