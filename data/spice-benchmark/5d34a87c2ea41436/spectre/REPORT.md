...
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Large-Signal Transient | ✓ | Max Current: 2.793e-05A, Rise Time: 0.1ps |
| Switching Simulations | ✓ | Propagation Delay: 14.3ps |
...
| Drain current properly measured | ✓ | Range: -1.79e-02 to 2.56e-08A |
...
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Large Signal Transient Verified | ✓ | Max Drain Current: 2.793e-05A |

### Switching Simulations
| Test Type | Status | Key Findings |
|-----------|--------|-------------|
| Propagation Delay Verified | ✓ | 14.3ps |
