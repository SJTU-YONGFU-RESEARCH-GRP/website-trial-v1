...
Generated on: 2026-07-27 06:30:17
...
- [<span style='color: green'>✓</span>] Circuit file exists and is readable
  - Path: /home/duhaochen/website-trial-v1/data/spice-model-benchmark/fa1033083b0626d930bc9493490d7484/ngspice/_ngspice_netlists/dc_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/fa1033083b0626d930bc9493490d7484/ngspice/_ngspice_netlists/transient_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/fa1033083b0626d930bc9493490d7484/ngspice/_ngspice_netlists/noise_circuit.cir, /home/duhaochen/website-trial-v1/data/spice-model-benchmark/fa1033083b0626d930bc9493490d7484/ngspice/_ngspice_netlists/ac_circuit.cir
...
| [Bias Point Analysis](#bias-point-analysis) | <span style='color: green'>✓</span> | Points: 9 VDS points, 9 VGS points, Currents: IDS: -1.02e-03A to 0.00e+00A, IG: 0.00e+00A to 0.00e+00A, IS: 0.00e+00A to 1.02e-03A, IB: 0.00e+00A to 1.20e-15A, KCL Error: 0.00%, Power: 0.00e+00W to 1.22e-03W, Temp: -40°C |
...
| [Thermodynamic Analysis](#thermodynamic-analysis) | <span style='color: green'>✓</span> | Power: 0.000e+00W to 1.646e-03W, Efficiency: 3.005e+00 to 2.885e+11, TC: nan/°C |

### AC Analysis Summary
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Small Signal Analysis](#small-signal-analysis) | <span style='color: green'>✓</span> | Gate capacitance range: 22.86fF to 84.69fF |
| [S-Parameter Analysis](#s-parameter-analysis) | <span style='color: green'>✓</span> | S11 range: -0dB to 0dB, S21 range: -17dB to -17dB |
| [Non-Quasi-Static (NQS) Effects Analysis](#non-quasi-static-effects-analysis) | <span style='color: green'>✓</span> | Max phase shift: 179.926 |
...
| Check Type | Status | Key Findings |
|-----------|--------|-------------|
| [Large-Signal Transient](#large-signal-transient) | <span style='color: green'>✓</span> | Max Current: 4.219e-05A, Rise Time: 0.4ps |
| [Switching Simulations](#switching-simulations) | <span style='color: green'>✓</span> | Propagation Delay: 243.8ps, Power: 1.135e-03W (max), 9.068e-05W (avg) |
| [Delay Effect](#delay-effect-simulations) | <span style='color: green'>✓</span> | Total Chain Delay: 1591.5ps |
| [Power Dissipation](#transient-simulations-for-power-dissipation) | <span style='color: green'>✓</span> | Temp Coeff: -1.010667e-06W/°C |
...
- [<span style='color: green'>✓</span>] Energy is conserved
  - Power Range: 0.000e+00W to 1.646e-03W
- [<span style='color: green'>✓</span>] Device is efficient
  - Efficiency Range: 3.005e+00 to 2.885e+11
- [<span style='color: green'>✓</span>] Temperature coefficient is calculated
  - Value: nan/°C
...
- [<span style='color: green'>✓</span>] Large Signal Transient Verified
  - Maximum Drain Current: 4.219250e-05A
...
- [<span style='color: green'>✓</span>] Propagation Delay Verified
  - Propagation Delay: 243.8ps

  - Maximum Switching Power: 1.135164e-03W

  - Average Switching Power: 9.067847e-05W
...
- [<span style='color: green'>✓</span>] Propagation delay through inverter chain analyzed
  - Stage 1 Delay: 408.1ps

  - Stage 2 Delay: 824.5ps

  - Stage 3 Delay: 358.9ps

  - Total Delay: 1591.5ps
...
- [<span style='color: green'>✓</span>] Temperature-dependent power analysis completed
  - Maximum Power at 27°C: 1.135164e-03W

  - Maximum Power at 100°C: 1.061385e-03W

  - Average Power at 27°C: 9.067847e-05W

  - Average Power at 100°C: 7.209250e-05W

  - Power Temperature Coefficient: -1.010667e-06W/°C
...
- [<span style='color: green'>✓</span>] AC small-signal simulations verified
  - Gate capacitance range: 22.86fF to 84.69fF
...
- [<span style='color: green'>✓</span>] Large-signal capacitances computed from AC C(V) integral
  ...
  - Per-gate-area (W*L) normalization available
    ...
    - Cgg_ls/Area: 4.792008 fF/µm²
    - Cgs_ls/Area: -1.159817 fF/µm²
    - Cgd_ls/Area: -0.812494 fF/µm²
    - Cgb_ls/Area: -2.819700 fF/µm²
...
- Started: `2026-07-26T22:29:41.173790+00:00`
- Finished: `2026-07-26T22:30:18.260820+00:00`
- Elapsed seconds: `37.08701`
- Peak resident memory KiB: `218292`
